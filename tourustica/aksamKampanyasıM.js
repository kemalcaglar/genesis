...
if (hour > 1 && hour < 24 || hour > -1 && hour < 9) {
    if (window.location.pathname == "/") {
        if (!getCookie('yearPopup')) {
            ...
            <span class="copy-kod" style="font-size:11px;display:none;z-index:999999;background-color:white;position:absolute;padding:3px;bottom:-24px;left:23%;border-radius:5px;border:1px solid rgb(0, 0, 0);">KOD KOPYALANDI</span>
            </div>
`;

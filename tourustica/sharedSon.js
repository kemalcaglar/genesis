(function () {
    if (EightDigits.sf.prototype.hasOwnProperty("Share_Button_Desktop")) {
        return false
    }
    EightDigits.sf.prototype.Share_Button_Desktop = function () {

        var config = {
            scenarioname: "Share_Button_Desktop",
            analytics: "Share_Button_Desktop",
            controlgroup: 0
        };
...
var windowWidth = window.innerWidth / 2 - 43.5;
var shareIcon ='<div class="smpl-share-icon-button" style="margin-left:5px;color:black;width:30px;height:30px;"><svg fill="#dc242d" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" version="1.1" width="30" height="30" id="Capa_1" x="0px" y="0px" viewBox="0 0 426.667 426.667" style="enable-background:new 0 0 426.667 426.667;" xml:space="preserve"><g><g><path d="M352,256c-23.983,0-45.13,11.569-58.801,29.201l-144.438-55.553c0.146-1.897,0.572-3.714,0.572-5.647    c0-3.589-0.568-7.025-1.06-10.479l148.009-68.32c13.693,15.487,33.473,25.466,55.717,25.466c41.167,0,74.667-33.5,74.667-74.667    c0-41.167-33.5-74.667-74.667-74.667S277.333,54.833,277.333,96c0,3.589,0.568,7.025,1.06,10.479l-148.009,68.32    c-13.693-15.487-33.473-25.466-55.717-25.466C33.5,149.333,0,182.833,0,224c0,41.167,33.5,74.667,74.667,74.667    c23.983,0,45.13-11.569,58.801-29.201l144.438,55.553c-0.146,1.897-0.572,3.714-0.572,5.647c0,41.167,33.5,74.667,74.667,74.667    s74.667-33.5,74.667-74.667C426.667,289.5,393.167,256,352,256z"/></g></g></svg></div>';
...
var shareIconContainer =`<div class='smpl-share-icon-container'>
<span class='copy-text' style='font-size:11px;display:none;z-index:999999;background-color:white;position:absolute;padding:5px;bottom:-30px;left:18%;border-radius:5px;border:1px solid rgb(0, 0, 0);'>Link Kopyalandı</span>
...
width: 20px; margin-right: 15px;"><span>E-mail</span></a></div>
...
<img style="width: 20px; margin-right: 15px;" src="`+icon_.twitter+`"><span>Twitter</span></a></div>
...
<img style="width: 20px; margin-right: 15px;" src="`+icon_.facebook+`"><span>Facebook</span></a></div>
<div class='smpl-share-icon' style="width: 92px;"><a class='smpl-icon-copy' href='javascript:void(0);'>`+icon_.copy+`<span class="smpl-copy" style="margin-left: 15px; color:#333; text-decoration:none;">Kopyala</span></a>
</div>
</div>`;
jQuery('.smpl-share-icon-button').append(shareIconContainer);
var iconStyle = "\
<style>\
...
.smpl-social-button:hover {\
    text-decoration: none;\
    color:#333;\
}\
.smpl-icon-copy:hover {\
    text-decoration: none;\
}\
</style>\
"
...
jQuery( ".smpl-share-icon-button" ).hover(function() {
    ...
    jQuery(".smpl-share-icon-container").toggle()
})
...
jQuery('.smpl-icon-facebook').click(function(){
    ...
    var _ed_Share_Button_Desktop = new EightDigits.sf();
    _ed_Share_Button_Desktop.Share_Button_Desktop();
})();

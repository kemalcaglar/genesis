(function () {
  if (EightDigits.sf.prototype.hasOwnProperty("Yenilenmis_Badge_ListelemeM")) {
    return false;
  }
  EightDigits.sf.prototype.Yenilenmis_Badge_ListelemeM = function () {
    var config = {
      scenarioname: "Yenilenmis_Badge_ListelemeM",
      analytics: "Yenilenmis_Badge_ListelemeM",
      controlgroup: 0,
    };
    var main = {
      factory: function () {
...
jQuery(".hotel-cell.with-row.hotel").map(function(){
  if(hotelID.find(x=>x===jQuery(this).attr("data-hotel-id"))){
    jQuery(this).find(".hotel-name").after(html);
}
})
        var showCount = 0;
  ...
  var _ed_Yenilenmis_Badge_ListelemeM = new EightDigits.sf();
  _ed_Yenilenmis_Badge_ListelemeM.Yenilenmis_Badge_ListelemeM();
})();

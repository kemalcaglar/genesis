(function () {
  if (EightDigits.sf.prototype.hasOwnProperty("Tourustica_Erken_Rez_SayacM")) {
     return false
  }
  EightDigits.sf.prototype.Tourustica_Erken_Rez_SayacM = function () {
      var config = {
          scenarioname: "Tourustica_Erken_Rez_SayacM",
          analytics: "Tourustica_Erken_Rez_SayacM_Son_Gun_8Mart",
          img: "//cdn.8digits.com/log/r/8b41f2be-c6db-4cb0-b137-3f05f5956055.jpeg",
      ...
      main.factory.prototype = {
          ...
          start: function () {
              ...
              <div id="ed_'+ config.scenarioname + '_main" style="position:relative;background-color:' + config.backgroundColorAttr + '; cursor:pointer;">\
                  ...
                  <div class="_ed_timer_el_day_tt" style="position:absolute;width: 70px;height: 40px;right: 513px;top: 9px;margin-left: 7px;font-size: 20px;color:#fefefe;font-weight:bold;">\
                      <div class="ed-inner-timer" style="float:left;"></div>\
                      <div class="ed-inner-timer" style="  margin-left: 9px;"></div>\
                    </div>\
                   <div class="_ed_timer_el_hour_tt" style="position:absolute;width: 70px;height: 40px;right: 461px;top: 9px;margin-left: 7px;font-size: 20px;color:#fefefe;font-weight:bold;">\
                      <div class="ed-inner-timer" style="float:left;"></div>\
                      <div class="ed-inner-timer" style="  margin-left: 9px;"></div>\
                   </div>\
                   <div class="_ed_timer_el_minute_tt" style="position:absolute;width: 70px;height: 40px;right: 419px;top: 9px;margin-left: 7px;font-size: 20px;color:#fefefe;font-weight:bold;">\
                      <div class="ed-inner-timer" style="float:left;"></div>\
                      <div class="ed-inner-timer" style="  margin-left: 9px;"></div>\
                   </div>\
                  </div>\
  ...
  var _ed_Tourustica_Erken_Rez_SayacM = new EightDigits.sf();
  _ed_Tourustica_Erken_Rez_SayacM.Tourustica_Erken_Rez_SayacM();
})()
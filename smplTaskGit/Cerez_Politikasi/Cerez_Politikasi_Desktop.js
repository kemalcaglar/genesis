(function () {
  if (EightDigits.sf.prototype.hasOwnProperty('Cerez_Politikasi_Desktop')) {
    return false;
  }
  EightDigits.sf.prototype.Cerez_Politikasi_Desktop = function () {

    var config = {
      scenarioname: 'Cerez_Politikasi_Desktop',
      analytics: 'Cerez_Politikasi_Desktop',
      controlgroup: 0,
    };
    ...
    main.factory.prototype = {
      ...
      start: function () {
        var cerezHtml = '\
                    <div id="' + config.scenarioname + '_cerez_main" style="width: 350px;border-radius: 4px;background-color: rgba(0, 0, 0,80%);z-index: 9999;position: fixed;left: 20px;bottom: 18px;">\
  ...
  var _ed_Cerez_Politikasi_Desktop = new EightDigits.sf();
  _ed_Cerez_Politikasi_Desktop.Cerez_Politikasi_Desktop();
})();

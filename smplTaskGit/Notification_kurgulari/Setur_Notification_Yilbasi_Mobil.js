(function () {
  if (EightDigits.sf.prototype.hasOwnProperty("Setur_Notification_Yilbasi_Mobil")) {
    return false
  }
  EightDigits.sf.prototype.Setur_Notification_Yilbasi_Mobil = function () {
    var config = {
      scenarioname: "Setur_Notification_Yilbasi_Mobil",
      scenarioclass: ".Setur_Notification_Yilbasi_Mobil",
      analytics: "Setur_Notification_Yilbasi_Mobil",
      ...
      start: function () {
        ...
        jQuery(appendEl).append(html);
          ...
          if (appendEl === ".top-user-area") {
            jQuery(config.scenarioclass + "-main").css({ "top": "-5px", "margin-left": "-55px" })
            jQuery(config.scenarioclass + "-list").css({ "top": "40px", "right": "-110px" })
            jQuery(config.scenarioclass + "-main .smpl-count").css({"top":"-8px","left":"30px"})
            jQuery(config.scenarioclass + "-main .yilbasiImg").css({"width":"26px"})
          } else {
            jQuery(config.scenarioclass + "-list").css({ "top": "35px", "right": "-130px"})
            jQuery(config.scenarioclass + "-main .smpl-count").css({"top":"-8px","left":"30px"})
            jQuery(config.scenarioclass + "-main").css({ "top": "-13px", "margin-left": "15px" })
            jQuery(config.scenarioclass + "-main .yilbasiImg").css({"width":"26px"})
          }
  ...
  var _ed_Setur_Notification_Yilbasi_Mobil = new EightDigits.sf();
  _ed_Setur_Notification_Yilbasi_Mobil.Setur_Notification_Yilbasi_Mobil();
})();

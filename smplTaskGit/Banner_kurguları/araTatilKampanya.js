(function () {
  const scenarioName = "ara_Tatil_Kampanyasi";
  ...
  EightDigits.sf.prototype[scenarioName] = function () {
    ...
    main.factory.prototype = {
      ...
      start: function () {
        ...
        main.factory.prototype.fireEvent("shown-headerBanner", true);
        jQuery(`.smpl_${config.scenarioname}_header a`).on("click",function () {
        ...
        jQuery(`.smpl_${config.scenarioname} .copyCode`).click(function () {
          ...
          main.factory.prototype.fireEvent("click_CopyCode");
        });
        jQuery(".closePop").click(function () {
          jQuery(`.smpl_${config.scenarioname}`).removeClass("smpl_flex");
          main.factory.prototype.fireEvent("click_PopupClose");
        });

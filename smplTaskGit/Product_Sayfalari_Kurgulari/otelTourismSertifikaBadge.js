(function () {
    if (EightDigits.sf.prototype.hasOwnProperty("otelTourismSertifikaBadge")) {
        return false
    }
    EightDigits.sf.prototype.otelTourismSertifikaBadge = function () {

        var config = {
            scenarioname: "otelTourismSertifikaBadge",
            analytics: "otelTourismSertifikaBadge",
            controlgroup: 0
        };
        ...
        main.factory.prototype = {
            ...
            start: function () {     
                ...
                if(CoronaList.includes(jQuery('.hotel-detail-name').text().trim())){
                jQuery('.hotel-detail-name').append('<img src="https://cdn.8digits.com/f/u/s2adg7rq/94373319-3e98-4d51-b4e2-b881f3f26677.png" style=" width: 55px; float: right;"></img>');
    ...
    var _ed_otelTourismSertifikaBadge = new EightDigits.sf();
    _ed_otelTourismSertifikaBadge.otelTourismSertifikaBadge();
})();

(function () {
  const scenarioName = "Kaya_Palazzo_Konser_Banner";
    ...
    main.factory.prototype = {
      ...
      start: function () {
        ...
        if (window.innerWidth > 768) {
          image = "https://cdn.8digits.com/log/r/a3414b43-0799-4434-aac4-a3f58cfcb866.jpeg";
          scroll = 1100;
        } else {
          image = "https://cdn.8digits.com/log/r/7bd14c8e-6605-4c41-b9f3-cddf368b52f4.jpeg";
          scroll = 1500;
        }
        const html = `
      ...
      control: function () {
        if (window.location.pathname === "/kaya-palazzo-resort-casino") {
          return true;
        } else {
          return false;
        }

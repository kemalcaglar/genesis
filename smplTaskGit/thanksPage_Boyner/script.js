(function () {
  const scenarioName = "Boyner_Yeni";
  ...
  EightDigits.sf.prototype[scenarioName] = function () {
    let config = {
      ...
      campaingText: "Setur Boyner Kampanyası",
      campaingLink: "https://www.boyner.com.tr/",
      cookeiName: "boynerCampaing"
    };
    let main = {
      factory: function () {
        return true;
    ...
    main.factory.prototype = {
      ...
      displayCampaing: function (coupon) {
        ...
        let listItem = [
          "Kampanya, 30 Eylül 2021 tarihine kadar Boyner.com.tr’den yapılacak Boyner Express♥Bodrum ürünlerinde geçerlidir.",
        ...
        let html = {
          ...
          list: function () {
            ...
            for (const iterator of listItem) {
              listHtml += `<li>${iterator}</li>`;
            }
            return listHtml;
          }
        };

        jQuery(".tour-reservation-container").append(html.content());
      ...
      start: function () {
        ...
        //   }
        // };
        // if (EightDigits.utils.getCookie(`smpl_${config.cookeiName}`) === "on") {
        //   getCoupon();
        //   EightDigits.utils.setCookie(`smpl_${config.cookeiName}`, "on", -1);
        // }
        main.factory.prototype.displayCampaing("12345");
        ...
        if (window.location.pathname === "/Sepet") {
          ...
          if (mount >= 2000) {
            jQuery("#btnCompleteOrder").click(function () {
              EightDigits.utils.setCookie(`smpl_${config.cookeiName}`, "on");
            });
          }
          return false;
        }

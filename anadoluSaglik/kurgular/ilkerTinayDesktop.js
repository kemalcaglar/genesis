(function () {
  if (EightDigits.sf.prototype.hasOwnProperty("Ilker_Tinay_Kulakcik")) {
    return false;
  }
  EightDigits.sf.prototype.Ilker_Tinay_Kulakcik = function () {
    var config = {
      scenarioname: "Ilker_Tinay_Kulakcik",
      analytics: "Ilker_Tinay_Kulakcik",
      imgSrc:
        "https://cdn.8digits.com/log/r/93248aab-ebec-4c97-96d0-256227a923a2.jpeg",
    ...
    main.factory.prototype = {
      ...
      start: function () {
        ...
        <a href="https://www.anadolusaglik.org/uroonkoloji-merkezi">\
        <span style="\
        position: absolute;\
        top: 30px;\
        left: 10px;\
        ...
        border-radius: 5px;\
        padding: 5px;">Prostat Kanseri Tedavisi’nde<br>Üroonkoloji Merkezi</span>\
        </a>\
  ...
  var _ed_Ilker_Tinay_Kulakcik = new EightDigits.sf();
  _ed_Ilker_Tinay_Kulakcik.Ilker_Tinay_Kulakcik();
})();

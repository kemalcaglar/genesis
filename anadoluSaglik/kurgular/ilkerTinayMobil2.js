(function () {
    if (EightDigits.sf.prototype.hasOwnProperty("Ilker_Tinay_Kulakcik_Card_Mobil")) {
      return false;
    }
    EightDigits.sf.prototype.Ilker_Tinay_Kulakcik_Card_Mobil = function () {
      var config = {
        scenarioname: "Ilker_Tinay_Kulakcik_Card_Mobil",
        analytics: "Ilker_Tinay_Kulakcik_Card_Mobil",
        imgSrc:
  ...
  jQuery("body").append(htmlFixed);
    ...
    var _ed_Ilker_Tinay_Kulakcik_Card_Mobil = new EightDigits.sf();
    _ed_Ilker_Tinay_Kulakcik_Card_Mobil.Ilker_Tinay_Kulakcik_Card_Mobil();
  })();

(function () {
    if (EightDigits.sf.prototype.hasOwnProperty("Metin_Cakmakci_Kulakcik")) {
      return false;
    }
    EightDigits.sf.prototype.Metin_Cakmakci_Kulakcik = function () {
      var config = {
        scenarioname: "Metin_Cakmakci_Kulakcik",
        analytics: "Metin_Cakmakci_Kulakcik",
        imgSrc:
          "https://cdn.8digits.com/log/r/30f9f36f-2fd7-4b0f-82cd-c67b31e8fa91.jpeg",
      ...
      main.factory.prototype = {
        ...
        start: function () {
          ...
          <a href="https://www.anadolusaglik.org/genel-cerrahi">\
          <span style="\
          position: absolute;\
          top: 30px;\
          left: 8px;\
          ...
          border-radius: 5px;\
          padding: 5px;">Meme Sağlığı Merkezi Direktörü<br>Genel Cerrahi Uzmanı</span>\
          </a>\
    ...
    var _ed_Metin_Cakmakci_Kulakcik = new EightDigits.sf();
    _ed_Metin_Cakmakci_Kulakcik.Metin_Cakmakci_Kulakcik();
  })();

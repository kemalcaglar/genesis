(function () {
    if (EightDigits.sf.prototype.hasOwnProperty("Metin_Cakmakci_Kulakcik_Card_Mobil")) {
        return false
    }
    EightDigits.sf.prototype.Metin_Cakmakci_Kulakcik_Card_Mobil = function () {
        var config = {
            scenarioname: "Metin_Cakmakci_Kulakcik_Card_Mobil",
            analytics: "Metin_Cakmakci_Kulakcik_Card_Mobil",
            imgSrc:
      ...
      jQuery("body").append(htmlFixed);
        ...
        var _ed_Metin_Cakmakci_Kulakcik_Card_Mobil = new EightDigits.sf();
        _ed_Metin_Cakmakci_Kulakcik_Card_Mobil.Metin_Cakmakci_Kulakcik_Card_Mobil();
      })();
(function () {
    if (EightDigits.sf.prototype.hasOwnProperty("Genel_Cerrahi_Kulakcik_Desktop")) {
        return false
    }
    EightDigits.sf.prototype.Genel_Cerrahi_Kulakcik_Desktop = function () {
        var config = {
            scenarioname: "Genel_Cerrahi_Kulakcik_Desktop",
            analytics: "Genel_Cerrahi_Kulakcik_Desktop",
            imgSrc:
            "https://cdn.8digits.com/log/r/690ddad8-18f3-410c-b7f6-3ba53d8a2dda.jpeg",
            imgSrc2: "https://cdn.8digits.com/log/r/690ddad8-18f3-410c-b7f6-3ba53d8a2dda.jpeg",
          altPropertie: "Bilgi ve Randevu İçin Tıklayın",
          mainLink:
            "https://www.anadolusaglik.org/doktor/prof-dr-metin-cakmakci",
          direction:
            "https://www.anadolusaglik.org/genel-cerrahi",
        ...
        main.factory.prototype = {
            ...
            start: function () {
              ...
              jQuery("head").append(css);
                if(window.location.pathname === "/genel-cerrahi"){
            ...
            setTimeout(() => {
              ...
              if (link == "https://www.anadolusaglik.org/genel-cerrahi" && isCookieOn == "on") {
                  jQuery(".ed-SKcontainer").hide();
                  jQuery(".smpl-doctor").css({"display":"block"})
                  jQuery('.chapterDoctors').before(jQuery("#usQuestionForm-contact"))
                  setTimeout(function(){
    ...
    var _ed_Genel_Cerrahi_Kulakcik_Desktop = new EightDigits.sf();
    _ed_Genel_Cerrahi_Kulakcik_Desktop.Genel_Cerrahi_Kulakcik_Desktop();
  })();
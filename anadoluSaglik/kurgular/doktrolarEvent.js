(function () {
    if (EightDigits.sf.prototype.hasOwnProperty("Doktorlar_Event_Mobil")) {
        return false
    }
    EightDigits.sf.prototype.Doktorlar_Event_Mobil = function () {
        var config = {
            scenarioname: "Doktorlar_Event_Mobil",
            analytics: "Doktorlar_Event_Mobil",
            controlgroup: 0
        };
        var main = {
            "factory": function () {
    ...
    var _ed_Doktorlar_Event_Mobil = new EightDigits.sf();
    _ed_Doktorlar_Event_Mobil.Doktorlar_Event_Mobil();
  })();
                ...
                if (window.location.pathname.indexOf("/en/") > -1) {
                    ...
                    <div class="${config.scenarioname}-desktop">
                        <a href="http://bit.ly/Hemen-Abone-Olun">
                            <img style="width:100%;" src="https://cdn.8digits.com/log/r/08e6d62d-52a0-425f-89dd-f8685dd6cd43.jpeg">
                        </a>
                    </div>
                    `
                        jQuery(".section.header").before(html)
                        EightDigits.analytics.sendEvent(config.analytics, "shown-header-en")
                        jQuery("Meme_Sagligi_Header-desktop").click(function () {
                            EightDigits.analytics.sendEvent(config.analytics, "click-header-en")
                        })
                    } else {
                        var html = `
                        <div class="${config.scenarioname}-mobil">
                            <a href="http://bit.ly/Hemen-Abone-Olun">
                                <img style="width:100%;" src="https://cdn.8digits.com/log/r/cba71645-f793-4715-98a0-cefb9db185de.jpeg">
                            </a>
                        </div>
                        `
                        ...
                        if (jQuery("#wrapper").length === 1) {
                            ...
                            EightDigits.analytics.sendEvent(config.analytics, "shown-header-en-mobil")
                            jQuery("Meme_Sagligi_Header-mobil").click(function () {
                                EightDigits.analytics.sendEvent(config.analytics, "click-header-en-mobil")
                            })
                        }
                    }
                } else {
                    ...
                    `
                        ...
                        if (jQuery("#wrapper").length === 1) {
                            jQuery(".h-mmenu-button.mobilemenu-trigger").css({ "top": "23.9rem" })
                            jQuery(".h-mphone-button.event-tel-link").css({ "top": "24.5rem" })
                            EightDigits.analytics.sendEvent(config.analytics, "shown-header-mobil")
                            jQuery("Meme_Sagligi_Header-mobil").click(function () {
                                EightDigits.analytics.sendEvent(config.analytics, "click-header-mobil")
                            })
                        }
                    }
                }

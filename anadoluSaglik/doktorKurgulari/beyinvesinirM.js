(function () {
    if (EightDigits.sf.prototype.hasOwnProperty("Beyin_Sinir_Kulakcik_Mobile")) {
        return false
    }
    EightDigits.sf.prototype.Beyin_Sinir_Kulakcik_Mobile = function () {
        var config = {
            scenarioname: "Beyin_Sinir_Kulakcik_Mobile",
            analytics: "Beyin_Sinir_Kulakcik_Mobile",
            imgSrc:
    ...
    var _ed_Beyin_Sinir_Kulakcik_Mobile = new EightDigits.sf();
    _ed_Beyin_Sinir_Kulakcik_Mobile.Beyin_Sinir_Kulakcik_Mobile();
  })();
(function () {
    if (EightDigits.sf.prototype.hasOwnProperty("Kezban_Berberoglu_Kulakcik")) {
      return false;
    }
    EightDigits.sf.prototype.Kezban_Berberoglu_Kulakcik = function () {
      var config = {
        scenarioname: "Kezban_Berberoglu_Kulakcik",
        analytics: "Kezban_Berberoglu_Kulakcik",
        imgSrc:
          "https://cdn.8digits.com/log/r/fad116cc-b5a9-411a-82ac-e983f226abcf.jpeg",
        altPropertie: "Bilgi ve Randevu İçin Tıklayın",
        mainLink:
          "https://www.anadolusaglik.org/doktor/doc-dr-kezban-berberoglu",
        direction:
          "https://www.anadolusaglik.org/sizi-dinliyoruz?utm_source=smpl&utm_medium=drserefkomurcu&utm_campaign=tv",
    ...
    font-size: 19px;\
    font-weight: 600;\
  ">Nükleer Tıp Uzmanı</span>\
          <button class="ed-button smpl-randevu" style="height:59px">\
          <a href="' +
            config.direction +
            '" alt="' +
            config.altPropertie +
          ...
          <button class='ed-button smpl-ulasim' style='top:70%; height:59px; background: #094E87;'>\
    ...
    var _ed_Kezban_Berberoglu_Kulakcik = new EightDigits.sf();
    _ed_Kezban_Berberoglu_Kulakcik.Kezban_Berberoglu_Kulakcik();
  })();

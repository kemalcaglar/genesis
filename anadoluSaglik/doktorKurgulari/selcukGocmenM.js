(function () {
    if (EightDigits.sf.prototype.hasOwnProperty("Selcuk_Gocmen_Kulakcik_Card_Mobil")) {
      return false;
    }
    EightDigits.sf.prototype.Selcuk_Gocmen_Kulakcik_Card_Mobil = function () {
      var config = {
        scenarioname: "Selcuk_Gocmen_Kulakcik_Card_Mobil",
        analytics: "Selcuk_Gocmen_Kulakcik_Card_Mobil",
        imgSrc:
  ...
  jQuery("body").append(htmlFixed);
    ...
    var _ed_Selcuk_Gocmen_Kulakcik_Card_Mobil = new EightDigits.sf();
    _ed_Selcuk_Gocmen_Kulakcik_Card_Mobil.Selcuk_Gocmen_Kulakcik_Card_Mobil();
  })();

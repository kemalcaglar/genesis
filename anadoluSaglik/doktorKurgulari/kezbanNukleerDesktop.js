(function () {
    if (EightDigits.sf.prototype.hasOwnProperty("Nukleer_Kulakcik")) {
        return false
    }
    EightDigits.sf.prototype.Nukleer_Kulakcik = function () {
        var config = {
            scenarioname: "Nukleer_Kulakcik",
            analytics: "Nukleer_Kulakcik",
            imgSrc:
        ...
        main.factory.prototype = {
            ...
            start: function () {
              ...
              jQuery("head").append(css);
                if(window.location.pathname === "/nukleer-tip-bolumu"){
    ...
    var _ed_Nukleer_Kulakcik = new EightDigits.sf();
    _ed_Nukleer_Kulakcik.Nukleer_Kulakcik();
  })();
(function () {
    if (EightDigits.sf.prototype.hasOwnProperty("MedikalOnkoloji_Kulakcik_Mobile")) {
        return false
    }
    EightDigits.sf.prototype.MedikalOnkoloji_Kulakcik_Mobile = function () {
        var config = {
            scenarioname: "MedikalOnkoloji_Kulakcik_Mobile",
            analytics: "MedikalOnkoloji_Kulakcik_Mobile",
            imgSrc:
          ...
          mainLink:
            "ttps://www.anadolusaglik.org/doktor/prof-dr-seref-komurcu",
          direction:
      ...
      jQuery("body").append(htmlFixed);
            ...
            setTimeout(() => {
              ...
              if (link == "https://www.anadolusaglik.org/medikal-onkoloji-bolumu" && isCookieOn == "on") {
                  jQuery(".ed-SKcontainer").hide();
                  jQuery(".smpl-doctor").css({"display":"block"})
                  jQuery('.chapterDoctors').before(jQuery("#usQuestionForm-contact"))
                  setTimeout(function(){
    ...
    var _ed_MedikalOnkoloji_Kulakcik_Mobile = new EightDigits.sf();
    _ed_MedikalOnkoloji_Kulakcik_Mobile.MedikalOnkoloji_Kulakcik_Mobile();
  })();
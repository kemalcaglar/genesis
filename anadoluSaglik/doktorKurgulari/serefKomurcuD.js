(function () {
  if (EightDigits.sf.prototype.hasOwnProperty("Seref_Komurcu_Kulakcik")) {
    return false;
  }
  EightDigits.sf.prototype.Seref_Komurcu_Kulakcik = function () {
    var config = {
      scenarioname: "Seref_Komurcu_Kulakcik",
      analytics: "Seref_Komurcu_Kulakcik",
      imgSrc:
        "https://cdn.8digits.com/log/r/935d201a-59ba-4d27-b2b5-385ce413dc2f.png",
...
">Medikal Onkoloji Uzmanı</span>\
  ...
  var _ed_Seref_Komurcu_Kulakcik = new EightDigits.sf();
  _ed_Seref_Komurcu_Kulakcik.Seref_Komurcu_Kulakcik();
})();

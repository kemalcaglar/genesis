(function () {
  if (EightDigits.sf.prototype.hasOwnProperty("Altan_Kir_Kulakcik_Card_Mobil")) {
    return false;
  }
  EightDigits.sf.prototype.Altan_Kir_Kulakcik_Card_Mobil = function () {
    var config = {
      scenarioname: "Altan_Kir_Kulakcik_Card_Mobil",
      analytics: "Altan_Kir_Kulakcik_Card_Mobil",
      imgSrc:
  ...
  <div class="smpl-animate-button" style="background:#094E87; width:50%; height:100%;"><a href="'+config.directionTwo +'">\
      <button style="\
      left: 0;\
      margin-top: 4px;\
      margin-left: 5px;\
...
jQuery("body").append(htmlFixed);
  ...
  var _ed_Altan_Kir_Kulakcik_Card_Mobil = new EightDigits.sf();
  _ed_Altan_Kir_Kulakcik_Card_Mobil.Altan_Kir_Kulakcik_Card_Mobil();
})();

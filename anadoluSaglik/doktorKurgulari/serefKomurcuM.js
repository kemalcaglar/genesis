(function () {
    if (EightDigits.sf.prototype.hasOwnProperty("Seref_Komurcu_Kulakcik_Card_Mobil")) {
      return false;
    }
    EightDigits.sf.prototype.Seref_Komurcu_Kulakcik_Card_Mobil = function () {
      var config = {
        scenarioname: "Seref_Komurcu_Kulakcik_Card_Mobil",
        analytics: "Seref_Komurcu_Kulakcik_Card_Mobil",
        imgSrc:
  ...
  jQuery("body").append(htmlFixed);
    ...
    var _ed_Seref_Komurcu_Kulakcik_Card_Mobil = new EightDigits.sf();
    _ed_Seref_Komurcu_Kulakcik_Card_Mobil.Seref_Komurcu_Kulakcik_Card_Mobil();
  })();

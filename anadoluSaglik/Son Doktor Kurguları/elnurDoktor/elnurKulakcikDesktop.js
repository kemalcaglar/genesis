(function () {
  if (EightDigits.sf.prototype.hasOwnProperty("Elnur_Allahverdiyev_Kulakcik")) {
    return false;
  }
  EightDigits.sf.prototype.Elnur_Allahverdiyev_Kulakcik = function () {
    var config = {
      scenarioname: "Elnur_Allahverdiyev_Kulakcik",
      analytics: "Elnur_Allahverdiyev_Kulakcik",
      imgSrc:
        "https://cdn.8digits.com/log/r/83cbe988-6b1a-4cb1-ad13-6c8c583f01b4.jpeg",
    ...
    main.factory.prototype = {
      ...
      start: function () {
        ...
        <a href="https://www.anadolusaglik.org/uroloji-bolumu">\
        <span style="\
        position: absolute;\
        top: 30px;\
        left: 8px;\
        ...
        border-radius: 5px;\
        padding: 5px;\
        width: 197px;">Üroloji <br> Bölümü</span>\
        </a>\
  ...
  var _ed_Elnur_Allahverdiyev_Kulakcik = new EightDigits.sf();
  _ed_Elnur_Allahverdiyev_Kulakcik.Elnur_Allahverdiyev_Kulakcik();
})();

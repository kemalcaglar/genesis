(function () {
    if (EightDigits.sf.prototype.hasOwnProperty("Patoloji_Department_Kulakcik")) {
        return false
    }
    EightDigits.sf.prototype.Patoloji_Department_Kulakcik = function () {
        var config = {
            scenarioname: "Patoloji_Department_Kulakcik",
            analytics: "Patoloji_Department_Kulakcik",
            imgSrc:
            "https://cdn.8digits.com/log/r/b9a4f892-f72d-47d4-9a1d-2ded32a8baf0.jpeg",
          altPropertie: "Bilgi ve Randevu İçin Tıklayın",
          mainLink:
            "https://www.anadolusaglik.org/doktor/prof-dr-huseyin-baloglu",
          direction:
            "https://www.anadolusaglik.org/patoloji-bolumu",
        ...
        main.factory.prototype = {
            ...
            start: function () {
              ...
              jQuery("head").append(css);
                if(window.location.pathname === "/patoloji-bolumu"){
            ...
            setTimeout(() => {
              ...
              if (link == "https://www.anadolusaglik.org/patoloji-bolumu" && isCookieOn == "on") {
                  jQuery(".ed-SKcontainer").hide();
                  jQuery(".smpl-doctor").css({"display":"block"})
                  jQuery('.chapterDoctors').before(jQuery("#usQuestionForm-contact"))
                  setTimeout(function(){
    ...
    var _ed_Patoloji_Department_Kulakcik = new EightDigits.sf();
    _ed_Patoloji_Department_Kulakcik.Patoloji_Department_Kulakcik();
  })();
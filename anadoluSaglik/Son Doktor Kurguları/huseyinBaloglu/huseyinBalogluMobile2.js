(function () {
    if (EightDigits.sf.prototype.hasOwnProperty("Huseyin_Baloglu_Kulakcik_Card_Mobil")) {
        return false
    }
    EightDigits.sf.prototype.Huseyin_Baloglu_Kulakcik_Card_Mobil = function () {
        var config = {
            scenarioname: "Huseyin_Baloglu_Kulakcik_Card_Mobil",
            analytics: "Huseyin_Baloglu_Kulakcik_Card_Mobil",
            imgSrc:
      ...
      jQuery("body").append(htmlFixed);
        ...
        var _ed_Huseyin_Baloglu_Kulakcik_Card_Mobil = new EightDigits.sf();
        _ed_Huseyin_Baloglu_Kulakcik_Card_Mobil.Huseyin_Baloglu_Kulakcik_Card_Mobil();
      })();
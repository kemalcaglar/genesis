(function () {
    if (EightDigits.sf.prototype.hasOwnProperty("Murat_Dede_Kulakcik_Card_Mobil")) {
        return false
    }
    EightDigits.sf.prototype.Murat_Dede_Kulakcik_Card_Mobil = function () {
        var config = {
            scenarioname: "Murat_Dede_Kulakcik_Card_Mobil",
            analytics: "Murat_Dede_Kulakcik_Card_Mobil",
            imgSrc:
      ...
      jQuery("body").append(htmlFixed);
        ...
        var _ed_Murat_Dede_Kulakcik_Card_Mobil = new EightDigits.sf();
        _ed_Murat_Dede_Kulakcik_Card_Mobil.Murat_Dede_Kulakcik_Card_Mobil();
      })();
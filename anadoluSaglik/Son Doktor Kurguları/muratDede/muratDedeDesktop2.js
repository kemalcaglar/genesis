(function () {
    if (EightDigits.sf.prototype.hasOwnProperty("Jinekolojik_Onkoloji_Department_Kulakcik")) {
        return false
    }
    EightDigits.sf.prototype.Jinekolojik_Onkoloji_Department_Kulakcik = function () {
        var config = {
            scenarioname: "Jinekolojik_Onkoloji_Department_Kulakcik",
            analytics: "Jinekolojik_Onkoloji_Department_Kulakcik",
            imgSrc:
            "https://cdn.8digits.com/log/r/47ce6cdb-3dc9-4b85-9482-027627a21685.jpeg",
          altPropertie: "Bilgi ve Randevu İçin Tıklayın",
          mainLink:
            "https://www.anadolusaglik.org/doktor/prof-dr-murat-dede",
          direction:
            "https://www.anadolusaglik.org/jinekolojik-onkoloji-cerrahisi-bolumu",
        ...
        main.factory.prototype = {
            ...
            start: function () {
              ...
              jQuery("head").append(css);
                if(window.location.pathname === "/jinekolojik-onkoloji-cerrahisi-bolumu"){
            ...
            setTimeout(() => {
              ...
              if (link == "https://www.anadolusaglik.org/jinekolojik-onkoloji-cerrahisi-bolumu" && isCookieOn == "on") {
                  jQuery(".ed-SKcontainer").hide();
                  jQuery(".smpl-doctor").css({"display":"block"})
                  jQuery('.chapterDoctors').before(jQuery("#usQuestionForm-contact"))
                  setTimeout(function(){
    ...
    var _ed_Jinekolojik_Onkoloji_Department_Kulakcik = new EightDigits.sf();
    _ed_Jinekolojik_Onkoloji_Department_Kulakcik.Jinekolojik_Onkoloji_Department_Kulakcik();
  })();
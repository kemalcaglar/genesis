(function () {
    if (EightDigits.sf.prototype.hasOwnProperty("Murat_Dede_Kulakcik")) {
      return false;
    }
    EightDigits.sf.prototype.Murat_Dede_Kulakcik = function () {
      var config = {
        scenarioname: "Murat_Dede_Kulakcik",
        analytics: "Murat_Dede_Kulakcik",
        imgSrc:
          "https://cdn.8digits.com/log/r/3225eda7-38ea-4fc7-b8fc-456b19bba3e8.jpeg",
      ...
      main.factory.prototype = {
        ...
        start: function () {
          ...
          <a href="https://www.anadolusaglik.org/jinekolojik-onkoloji-cerrahisi-bolumu">\
          <span style="\
          position: absolute;\
          top: 30px;\
          left: 8px;\
          ...
          border-radius: 5px;\
          padding: 5px;\
          width: 197px;">Jinekolojik Onkoloji <br> Cerrahisi Uzmanı</span>\
          </a>\
    ...
    var _ed_Murat_Dede_Kulakcik = new EightDigits.sf();
    _ed_Murat_Dede_Kulakcik.Murat_Dede_Kulakcik();
  })();

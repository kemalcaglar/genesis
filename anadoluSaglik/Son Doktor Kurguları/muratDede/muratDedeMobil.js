(function () {
    if (EightDigits.sf.prototype.hasOwnProperty("Jinekolojik_Onkoloji_Department_Mobil")) {
        return false
    }
    EightDigits.sf.prototype.Jinekolojik_Onkoloji_Department_Mobil = function () {
        var config = {
            scenarioname: "Jinekolojik_Onkoloji_Department_Mobil",
            analytics: "Jinekolojik_Onkoloji_Department_Mobil",
            imgSrc:
    ...
    var _ed_Jinekolojik_Onkoloji_Department_Mobil = new EightDigits.sf();
    _ed_Jinekolojik_Onkoloji_Department_Mobil.Jinekolojik_Onkoloji_Department_Mobil();
  })();
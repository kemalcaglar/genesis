(function () {
  if (EightDigits.sf.prototype.hasOwnProperty("Beyin_Sinir_Cerrahisi_Kulakcik")) {
      return false
  }
  EightDigits.sf.prototype.Beyin_Sinir_Cerrahisi_Kulakcik = function () {
      var config = {
          scenarioname: "Beyin_Sinir_Cerrahisi_Kulakcik",
          analytics: "Beyin_Sinir_Cerrahisi_Kulakcik",
          imgSrc:
          "https://cdn.8digits.com/log/r/c0d54705-c79a-4282-ad95-8eb1b73c17de.jpeg",
      ...
      main.factory.prototype = {
          ...
          start: function () {
            ...
            jQuery("head").append(css);
              if(window.location.pathname === "/beyin-sinir-cerrahisi-norosirurji-bolumu"){
                 ...
                 <button class="ed-button smpl-randevu" style="height:52px; width:37%; right:9%; top:60%">\
                 <span>\
                 ' +
                   config.altPropertie +
                   "\
  ...
  var _ed_Beyin_Sinir_Cerrahisi_Kulakcik = new EightDigits.sf();
  _ed_Beyin_Sinir_Cerrahisi_Kulakcik.Beyin_Sinir_Cerrahisi_Kulakcik();
})();
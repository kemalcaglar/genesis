(function () {
  if (EightDigits.sf.prototype.hasOwnProperty("Serdar_Kahraman_Kulakcik")) {
    return false;
  }
  EightDigits.sf.prototype.Serdar_Kahraman_Kulakcik = function () {
    var config = {
      scenarioname: "Serdar_Kahraman_Kulakcik",
      analytics: "Serdar_Kahraman_Kulakcik",
      imgSrc:
        "https://cdn.8digits.com/log/r/ff936d28-953e-417d-8ff0-2e46ddbaab90.jpeg",
    ...
    main.factory.prototype = {
      ...
      start: function () {
        ...
        <a href="https://www.anadolusaglik.org/beyin-sinir-cerrahisi-norosirurji-bolumu">\
        <span style="\
        position: absolute;\
        top: 30px;\
        left: 8px;\
        ...
        border-radius: 5px;\
        padding: 5px;\
        width: 197px;">Beyin ve Sinir Cerrahisi <br> Bölümü Direktörü</span>\
        </a>\
  ...
  var _ed_Serdar_Kahraman_Kulakcik = new EightDigits.sf();
  _ed_Serdar_Kahraman_Kulakcik.Serdar_Kahraman_Kulakcik();
})();
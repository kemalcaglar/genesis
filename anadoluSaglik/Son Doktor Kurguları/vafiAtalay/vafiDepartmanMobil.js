(function () {
  if (EightDigits.sf.prototype.hasOwnProperty("Genel_Cerrahi_Department_Kulakcik_Mobil")) {
      return false
  }
  EightDigits.sf.prototype.Genel_Cerrahi_Department_Kulakcik_Mobil = function () {
      var config = {
          scenarioname: "Genel_Cerrahi_Department_Kulakcik_Mobil",
          analytics: "Genel_Cerrahi_Department_Kulakcik_Mobil",
          imgSrc:
          "https://cdn.8digits.com/log/r/87a9c7cb-8062-425f-a9fa-d5dfcdd9d201.png",
        altPropertie: "Bilgi ve Randevu İçin Tıklayın",
        mainLink:
          "https://www.anadolusaglik.org/doktor/doc-dr-vafi-atalay",
        direction:
  ...
  var _ed_Genel_Cerrahi_Department_Kulakcik_Mobil = new EightDigits.sf();
  _ed_Genel_Cerrahi_Department_Kulakcik_Mobil.Genel_Cerrahi_Department_Kulakcik_Mobil();
})();
(function () {
    if (EightDigits.sf.prototype.hasOwnProperty("Hale_Caglar_Kulakcik_Card_Mobil")) {
        return false
    }
    EightDigits.sf.prototype.Hale_Caglar_Kulakcik_Card_Mobil = function () {
        var config = {
            scenarioname: "Hale_Caglar_Kulakcik_Card_Mobil",
            analytics: "Hale_Caglar_Kulakcik_Card_Mobil",
            imgSrc:
      ...
      jQuery("body").append(htmlFixed);
        ...
        var _ed_Hale_Caglar_Kulakcik_Card_Mobil = new EightDigits.sf();
        _ed_Hale_Caglar_Kulakcik_Card_Mobil.Hale_Caglar_Kulakcik_Card_Mobil();
      })();
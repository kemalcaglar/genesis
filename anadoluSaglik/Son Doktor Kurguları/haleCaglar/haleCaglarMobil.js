(function () {
    if (EightDigits.sf.prototype.hasOwnProperty("Radyasyon_Onkolojisi_Department_Mobil")) {
        return false
    }
    EightDigits.sf.prototype.Radyasyon_Onkolojisi_Department_Mobil = function () {
        var config = {
            scenarioname: "Radyasyon_Onkolojisi_Department_Mobil",
            analytics: "Radyasyon_Onkolojisi_Department_Mobil",
            imgSrc:
    ...
    var _ed_Radyasyon_Onkolojisi_Department_Mobil = new EightDigits.sf();
    _ed_Radyasyon_Onkolojisi_Department_Mobil.Radyasyon_Onkolojisi_Department_Mobil();
  })();
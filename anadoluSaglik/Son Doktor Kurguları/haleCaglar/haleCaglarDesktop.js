(function () {
  if (EightDigits.sf.prototype.hasOwnProperty("Hale_Caglar_Kulakcik")) {
    return false;
  }
  EightDigits.sf.prototype.Hale_Caglar_Kulakcik = function () {
    var config = {
      scenarioname: "Hale_Caglar_Kulakcik",
      analytics: "Hale_Caglar_Kulakcik",
      imgSrc:
        "https://cdn.8digits.com/log/r/a459affd-1f95-47bc-979a-dc48c9d9a6cb.jpeg",
    ...
    main.factory.prototype = {
      ...
      start: function () {
        ...
        <a href="https://www.anadolusaglik.org/radyasyon-onkolojisi-bolumu">\
        <span style="\
        position: absolute;\
        top: 30px;\
        left: 8px;\
        ...
        border-radius: 5px;\
        padding: 5px;\
        width: 197px;">Radyasyon Onkolojisi <br> Uzmanı</span>\
        </a>\
  ...
  var _ed_Hale_Caglar_Kulakcik = new EightDigits.sf();
  _ed_Hale_Caglar_Kulakcik.Hale_Caglar_Kulakcik();
})();

(function () {
    if (EightDigits.sf.prototype.hasOwnProperty("Radyasyon_Onkolojisi_Department_Kulakcik")) {
        return false
    }
    EightDigits.sf.prototype.Radyasyon_Onkolojisi_Department_Kulakcik = function () {
        var config = {
            scenarioname: "Radyasyon_Onkolojisi_Department_Kulakcik",
            analytics: "Radyasyon_Onkolojisi_Department_Kulakcik",
            imgSrc:
            "https://cdn.8digits.com/log/r/30b72080-9319-4fac-ad2e-f6071d80e369.jpeg",
          altPropertie: "Bilgi ve Randevu İçin Tıklayın",
          mainLink:
            "https://www.anadolusaglik.org/doktor/prof-dr-hale-basak-caglar",
          direction:
            "https://www.anadolusaglik.org/radyasyon-onkolojisi-bolumu",
        ...
        main.factory.prototype = {
            ...
            start: function () {
              ...
              jQuery("head").append(css);
                if(window.location.pathname === "/radyasyon-onkolojisi-bolumu"){
            ...
            setTimeout(() => {
              ...
              if (link == "https://www.anadolusaglik.org/radyasyon-onkolojisi-bolumu" && isCookieOn == "on") {
                  jQuery(".ed-SKcontainer").hide();
                  jQuery(".smpl-doctor").css({"display":"block"})
                  jQuery('.chapterDoctors').before(jQuery("#usQuestionForm-contact"))
                  setTimeout(function(){
    ...
    var _ed_Radyasyon_Onkolojisi_Department_Kulakcik = new EightDigits.sf();
    _ed_Radyasyon_Onkolojisi_Department_Kulakcik.Radyasyon_Onkolojisi_Department_Kulakcik();
  })();
(function () {
    if (EightDigits.sf.prototype.hasOwnProperty("Medikal_Onkoloji_Kulakcik_Desktop")) {
        return false
    }
    EightDigits.sf.prototype.Medikal_Onkoloji_Kulakcik_Desktop = function () {
        var config = {
            scenarioname: "Medikal_Onkoloji_Kulakcik_Desktop",
            analytics: "Medikal_Onkoloji_Kulakcik_Desktop",
            imgSrc:
            "https://cdn.8digits.com/log/r/02b2ee95-a406-4161-a4cd-413333a4a009.jpeg",
            imgSrc2: "https://cdn.8digits.com/log/r/02b2ee95-a406-4161-a4cd-413333a4a009.jpeg",
          altPropertie: "Bilgi ve Randevu İçin Tıklayın",
          mainLink:
            "https://www.anadolusaglik.org/doktor/prof-dr-metin-cakmakci",
          direction:
        ...
        main.factory.prototype = {
            ...
            start: function () {
              ...
              jQuery("head").append(css);
                if(window.location.pathname === "/medikal-onkoloji-bolumu" || window.location.pathname === "/onkoloji-merkezi"){
            ...
            jQuery(".smpl-randevu").click(function(){
                jQuery(".ed-SKcontainer").hide();
                jQuery(".smpl-doctor").css({"display":"block"})
                if(window.location.href == "https://www.anadolusaglik.org/medikal-onkoloji-bolumu"){
            ...
            setTimeout(() => {
              ...
              if (link == "https://www.anadolusaglik.org/medikal-onkoloji-bolumu" || window.location.pathname === "/onkoloji-merkezi" && isCookieOn == "on") {
                  jQuery(".ed-SKcontainer").hide();
                  jQuery(".smpl-doctor").css({"display":"block"})
                  if(window.location.href == "https://www.anadolusaglik.org/medikal-onkoloji-bolumu"){
                  jQuery('.chapterDoctors').before(jQuery("#usQuestionForm-contact"))
    ...
    var _ed_Medikal_Onkoloji_Kulakcik_Desktop = new EightDigits.sf();
    _ed_Medikal_Onkoloji_Kulakcik_Desktop.Medikal_Onkoloji_Kulakcik_Desktop();
  })();
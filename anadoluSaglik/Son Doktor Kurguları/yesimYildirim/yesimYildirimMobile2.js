(function () {
    if (EightDigits.sf.prototype.hasOwnProperty("Yesim_Yildirim_Kulakcik_Card_Mobil")) {
        return false
    }
    EightDigits.sf.prototype.Yesim_Yildirim_Kulakcik_Card_Mobil = function () {
        var config = {
            scenarioname: "Yesim_Yildirim_Kulakcik_Card_Mobil",
            analytics: "Yesim_Yildirim_Kulakcik_Card_Mobil",
            imgSrc:
      ...
      jQuery("body").append(htmlFixed);
        ...
        var _ed_Yesim_Yildirim_Kulakcik_Card_Mobil = new EightDigits.sf();
        _ed_Yesim_Yildirim_Kulakcik_Card_Mobil.Yesim_Yildirim_Kulakcik_Card_Mobil();
      })();
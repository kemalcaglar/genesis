(function () {
    if (EightDigits.sf.prototype.hasOwnProperty("Medikal_Onkoloji_Mobil")) {
        return false
    }
    EightDigits.sf.prototype.Medikal_Onkoloji_Mobil = function () {
        var config = {
            scenarioname: "Medikal_Onkoloji_Mobil",
            analytics: "Medikal_Onkoloji_Mobil",
            imgSrc:
          ...
          mainLink:
            "https://www.anadolusaglik.org/doktor/prof-dr-yesim-yildirim",
          direction:
      ...
      jQuery("body").append(htmlFixed);
            ...
            setTimeout(() => {
              ...
              if (link == "https://www.anadolusaglik.org/medikal-onkoloji-bolumu" || link == "https://www.anadolusaglik.org/onkoloji-merkezi"  && isCookieOn == "on") {
                  jQuery(".ed-SKcontainer").hide();
                  jQuery(".smpl-doctor").css({"display":"block"})
                  if(link == "https://www.anadolusaglik.org/medikal-onkoloji-bolumu"){
                  jQuery('.chapterDoctors').before(jQuery("#usQuestionForm-contact"))
                }
                  setTimeout(function(){
                     jQuery("html, body").animate(
    ...
    var _ed_Medikal_Onkoloji_Mobil = new EightDigits.sf();
    _ed_Medikal_Onkoloji_Mobil.Medikal_Onkoloji_Mobil();
  })();
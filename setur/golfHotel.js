(function () {
  if (EightDigits.sf.prototype.hasOwnProperty("Sueno_Banner_Detay")) {
    return false;
  }
  EightDigits.sf.prototype.Sueno_Banner_Detay = function () {
    var config = {
      scenarioname: "Sueno_Banner_Detay",
      analytics: "Sueno_Banner_Detay",
      controlgroup: 0,
    };
    var main = {
      factory: function () {
...
<img src="https://cdn.8digits.com/log/r/7e86374d-6391-408f-adce-4e3fa3fa0b9a.jpeg">\
</div>\
';
jQuery(".content-partial-shadow").eq(4).after(html);
  ...
  var _ed_Sueno_Banner_Detay = new EightDigits.sf();
  _ed_Sueno_Banner_Detay.Sueno_Banner_Detay();
})();

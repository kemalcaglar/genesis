(function () {
    if (EightDigits.sf.prototype.hasOwnProperty("Hopi_Detay_Banner_Mobile")) {
        return false
    }
    EightDigits.sf.prototype.Hopi_Detay_Banner_Mobile = function () {
        var config = {
            scenarioname: "Hopi_Detay_Banner_Mobile",
            analytics: "Hopi_Detay_Banner_Mobile",
            controlgroup: 0
        };
        var main = {
            "factory": function () {
    ...
    var hotelList = [
        ...
        "Divan Bodrum",
        "D Resort Grand Azur",
        "Ilıca Hotel SPA & Welness Resort",
        ...
        "Grand Park Kemer",
        "Azure By Yelken",
        "Marmaris Romance Hotel",
        "The Lumos Deluxe",
        "Concorde De Luxe Resort",
        "Aeneas Hotel",
        "Club Afrodit Tatil Köyü",
        "Otel Fahri Uludağ",
        "La Capria Suite Hotel",
        "Bitez Garden Life Hotel & Suites",
        "Eken Resort Hotel",
        "Hotel Çamyuva Beach",
        "Erta Soyak Otel Uludağ",
        "Taksim International Hotel Obaköy",
        "Anadolu Hotels Bodrum",
        "White Park Otel",
        "Hotel Le Chalet Yazıcı",
        "Oz Hotels Sui",
        "Bilem High Class Hotel",
        "Side Sunport Hotel & Spa (ex.Side Sungate)",
        "Titanic Deluxe Bodrum",
        "Maxx Royal Belek Golf Resort",
        "Nazar Beach City & Resort Hotel",
        ...
        "Kekik Otel Selimiye",
        "Saint John Hotel",
        "Kırkınca Evleri Butik Hotel",
        "Şirince Taş Konak Hotel",
        "Cennet Life Otel",
        "La Paloma Hotel",
        ...
        "Botanik Grand Lukullus Hotel",
        "Botanik Magic Dream Hotel",
        ...
        "Kayalar Blue Beach Hotel",
        "İdahan Hotel",
        "Cunda Selene Otel",
        "Cunda Kıvrakzade Otel",
        "Grand Milano Hotel",
        "Kalif Hotel",
        "Lacivert Otel",
        "Megaş Hotel",
        ...
        "Enki Hotel",
        "Hotel Palmyra",
        "Hotel Dalyan Caria Royal ",
        "Club Mermaid Village",
        "Palmiye Beach Hotel",
        "Palmiye Park Apart Hotel",
        ...
        "Arora Hotel",
        "Aslı Boutique Otel",
        "Kanuni Kervansaray Historical Hotel",
        "Alalucca Butik Hotel",
        "Hideaway Hotel",
        "Payam Hotel",
        "Maritim Hotel Saray Regency",
        "The Diplomat Hotel & Apartments",
        "Taşev Butik Otel Çandarlı",
        ...
        "Erta Soyak Beach Bodrum",
        "Akra The Lifeco Antalya",
        "Han Deluxe Hotel",
        "Elvin Deluxe Hotel",
        ...
        "Dilek Ağacı Boutique Hotel & Beach",
        "Cappadocia Cave Resort & Spa",
        "Kemerlihan Deluxe Hotel",
        "Karmir Resort & Spa",
        "Senza Grand Santana Hotel",
        "Senza İnova Beach Hotel",
        "Perdikia Beach Fethiye",
        ...
        "Lykia World Links Golf Hotel",
        "Rezone Health & Oxygen Hotel Kazdağları",
        "Temenos Luxury Hotel & Spa",
        "Villa Otel Tamara",
        "Ena Boutique Hotel",
        "Perdue Hotel",
        "Peace Boutique Hotel",
        "Zakros Hotel Lykia",
        ...
        "Holiday City Hotel",
        "The D’ hotel Cesme Spa & Resort ",
        "Kondo Suites & Residence",
        "Delmar Suites & Residence",
        "Club Scala Nuova",
        "Scala Nuova İnkim",
        "Club Scala Nuova Anex",
        "Soothe Otel Kalkan",
        "Mirage Park Resort",
        "Spektr Otel Bodrum",
        "Otel Gümüşlük",
        ...
        "Alaçatı Hotel By Elit Event",
        "Beyaz İskele Hotel (Melek Hotel's Selimiye)",
        "Eski Datça Evleri",
        ...
        "White Tuana Thermal Hotel",
        "Kaya Uludağ",
        "Venüs Termal Butik Otel",
        "Thermo Vital Hotel",
        "Balçova Termal Otel",
        "Retaj Thermal Hotel",
        "Çobankaya Orman Köşkleri",
        "Uğur Termal Residence",
        "Magic Cave House Hotel",
        ...
        "Hotel Dena City",
        "Orka Park Villa",
        "Orka Diamond Collection Villa",
        "Orka New Four Seasons Villa",
        "Elisa Otel",
        "Orka Twin Villa",
        "Orka Sunset View Villa",
        "Orka Golden Heights Villa",
        "Cunda Aşiyan Butik Otel",
        "Troia Tusan Hotel",
        "Fila Otel Ayvalık",
        "Zen Alaçatı Hotel",
        "Alaçatı Private Hotel",
        "Kaş Artemis Hotel",
        "Hanedan Beach Hotel Foça",
        "Katina Hotel",
        "Mauna Hotel",
        "Bağbadem Tatil Çiftliği",
        "Muhit Alaçatı Butik Otel",
        "Venüs Otel",
        "Baga Hotel Akyaka +13 Adult Only",
        "Stone Hill Hotel",
        "Diva Residence Allsuite Hotel",
        "Allium Resort & SPA Bodrum",
        "Foça Otel 1887",
        "Ender Hotel",
        "Ören Konak Otel",
        "Alaçatı B House Hotel",
        "B&B Butik Hotel",
        "Rooms Bohemian Hotel",
        "Rooms Exclusive Hotel",
        "R Hotel By Rooms",
        "Joker Side Hill Suite Hotel",
        "Jinan Berk Otel",
        "Alaçatı Seven Rooms",
        "Club Prive By Rixos Belek",
        "Milestone 1915 Hotel",
        "Vera Stone Palace Resort",
        "Dalyan Live Spa Resort Hotel",
        "Macaron Konağı",
        "Cunda Villa Suit Otel",
        "Başkent Butik Hotel",
        "YundAntik Cunda Konakları",
        "Assos Sunaba Kasrı Otel",
        "Alaçatı 1881 Concept Hotel",
        "Solto Selimiye Hotel",
        "Era Otel Alacati",
        "Windtown Deluxe Alaçatı",
        "Alaçatı Mahzen Boutique Hotel",
        "Fragrante Hotel",
        "Yahşi Beach Otel",
        "Lavanta Hotel Turunç",
        "Eftelya Otel",
        "Hotel Triangulo",
        "Akay Garden Family Club",
        "Destina Hotel Bozcaada",
        "Destina Suit Otel Bozcaada",
        "Pırlanta Hotel",
        "Ketenci Hotel",
        "Sapanca Alfa Suites & Spa",
        "Hayat Bahçesi Dalyan Otel",
        "Cunda Sır Otel",
        ...
        "Nergiz Hotel",
        "The Bodrum EDITION",
        "Casa De Playa Luxury Hotel",
        "Medis Resort Hotel",
        "Cunda Mavi Otel",
        "Papazlıkhan Butik Otel",
        "Moonlight Boutique Hotel",
        "İda House Assos",
        "Güle Otel",
        "Salinas Hotel Bodrum",
        "Elia Otel Cunda By Ortunç",
        "Bozcaada Arcadia Butik Otel",
        "Life Apart",
        "Mardia Beach Hotel",
        "Mata Butik Hotel",
        ...
        "Club Vela Hotel",
        "Selvi Beach",
        "Lvzz Hotel Residence",
        "Savra Bodrum",
        "Moonshine Hotel Suites",
        "Delita Suite Hotel Boutique",
        "Monte Carlo Hotel",
        ...
        "Sailors Park Hotel",
        "Deja Vu Hotel Boutique",
        "Yetkin Club Hotel",
        "Can Garden Beach",
        "Adenya Resort Hotels & Spa",
        "Seven Stars Exclusive Hotel",
        "The Corner Park Hotel",
        "Sea Side Hotel Antalya",
        ...
        "Orfeus Hotel",
        "Orfeus Park Hotel",
        "Orfeus Queen Hotel & Spa",
        "Urcu Hotel",
        "Efe Boutique Hotel",
        "Rainbow Castle Hotel",
        "Karbelsun Hotel",
        "Livia Hotel",
        "Infinity City Hotel",
        ...
        "Akyalı Butik Hotel",
        "Nazar Otel",
        "Adonis Hotel Marmaris",
        "Fiska Boutique Hotel Selimiye",
        "Badem Tatil Evi",
        "Hotel Caeli Eceabat",
        "Peremere Otel Alaçatı",
        "Riviera Hotel & Spa",
        ...
        "La Pergola Butik Hotel",
        "Rhapsody Hotel Kaş",
        "Akpalace Belek",
        "Şevkibey Hotel",
        "Club Datça Tatil Köyü",
        "Merhaba Hotel",
        "Yeni Tolya Resort Hotel",
        ...
        "Lighthouse Natalia Aparts",
        "Lighthouse Tulip Villa",
        "Lighthouse Lydia Villa",
        "Lighthouse Alexa Villa",
        "Lighthouse Legend Aparts",
        "Garden Rüya Hotel",
        "Labranda Excelsior Side",
        "Club Hotel Sidar",
        "Smartline Sunpark Aramis Hotel",
        "Ambassador Hotel",
        "Suhan 360 Hotel",
        "Katre Otel",
        "Karya Palm Beach Hotel",
        "Karya Beach Hotel",
        "Assos Oleas Hotel",
        ...
        "Kale Hotel",
        "Gizemli Nehir Hotel",
        "Alapietra Butik Otel",
        "Dalian Elite Hotel",
        "Anzac Hotel",
        "Arion Resort Hotel",
        "Alaçatı Balbadem Otel",
        "Bodrum Oscar Hotel",
        ...
        "BC Spa Hotel",
        "Michelangelo Boutique Hotel",
        "Dalyan Resort Hotel",
        "Dalyan Resort Spa Hotel",
        "Baldan Suites Bozburun",
        "Adrasan Eldorado Otel",
        ...
        "Aral Tatil Çiftliği",
        "Anatolia Otel Bozcaada",
        "Casa Sevilla Alaçatı Town Butik Otel",
        "The S Ascend Collection Hotel",
        "Palm Beach Hotel",
        "Ege Han Otel",
        "Kozluhan Otel",
        "Eyes Of Cappadocia Hotel",
        "Maxholiday Hotels Belek",
        "Maxholiday Hotels Stone Palace Side",
        "De Boutique Hotel",
        "La Local Beach Hotel",
        "Melek Hotels Bozburun",
        "Dores Residence Hotel",
        "Ece Saray Marina Resort",
        "Larissa Phaselis Princess Hotel",
        "Saray Gold Hotel",
        "S White Hotel",
        "Mera Park Hotel",
        "Uçhisar Kaya Otel",
        ...
        "La Vida Blanca",
        "Hotel Baba",
        "The Elysium Miramar Bodrum",
        "Red Rock Hotel & Suites by Selvese",
        "Taç Premier Hotel",
        "Royal Garden Select Suite",
        "Novi Hotel Spa Bodrum",
        "Mylos Otel",
        "Şahika Konukevi",
        "Dalyan Rota Hotel",
        "Sea Life Buket Beach & Resort",
        "Porto Bello Hotel Resort & Spa",
        "Vento Boutique Hotel ",
        "Daisy Garden Resort",
        ...
        "Pachamama Hotel",
        "Nar Cave Hotel Kapadokya",
        "Acroter Hotel & SPA",
        "Marina Suite Taşucu ",
        "Bahar Aqua Resort Otel  ",
        "Marina Holmi Hotel ",
        "Club Nimara Beach Resort",
        "Casa Aria Hotel ",
        "Salkım Sahil Evi ",
        "Sonnen Hotel ",
        "Padok Premium Hotel & Stables ",
        "Dorman Suites Hotel ",
        "Zeren Alaçatı",
        "Dört Mevsim Alaçatı",
        "Zeytin Butik Pansiyon ",
        "Calidus Hotel ",
        "Sun Beach Resort Bodrum ",
        "Voxx Marmaris Beach Resort",
        "Beyaz Konak Evleri ",
        "Güllü Konakları ",
        "Martı Hemithea ",
        "Sandima 37 Suites Hotel",
        "Baraka Hisarönü ",
        "Kaya Side ",
        "Herodot Beach Hotel ",
        ...
        "Ayvalık Gizemli Konak",
        "Manej Urla Otel",
        "Siyah Lale Butik Otel",
        ...
        "Erciyes Hill Hotel",
        "Rif Sapanca ( Adult +12 )",
        "Penguen House Sapanca",
        "Ağva Deniz Yıldızı",
        "Acropol Of Bodrum Beach Hotel ",
        "Reyhan Hanım Konakları",
        "Heramis Termal Tatil Köyü",
        "Sör Yalıkavak",
        "Pita Hotel Cunda",
        "Downtown Fethiye Suites",
        "Egehan Butik Otel Dalyan",
        "Royal Çeşme Hotel",
        ...
        "Dokya Hotel",
        "Site Soley",
        "Villa Oliva Butik Otel",
        "Livan Otel Deluxe",
        "Seki Cave Çavuşin",
        "Aurasia City Hotel",
        "Oda Bodrum",
        "Corner In Cappadocia",
        ...
        "Suna Sun Boutique Hotel",
        "Altıner Otel",
        "Maslina Otel Ilıca",
        "Kordelya Hotel",
        "Sarot Thermal Palace Apart Hotel",
        "Savana Butik Otel",
        "Cunda Oteli",
        "Cunda Fora Glamping",
        "Casa De Sirena Apart Hotel",
        "Likya Gardens Hotel",
        "Double Inn Marina Hotel",
        "Monna Roza Garden Resort Hotel",
        "Monna Roza Beach Resort Hotel",
        "Kervan Tatil Köyü",
        "Kazdağları Sağlıklı Yaşam Köyü",
        "The Luna Suite Hotel",
        "Beyaz Yunus Hotel",
        "Soho Hotel Dalyan",
        ...
        "Şeyda Butik Otel",
        "Mavi Butik Otel",
        "Elyada Otel ve Bağ Evi",
        "Tenes Otel",
        "Lavinya Otel Bozcaada",
        "Aspasia House",
        "Güneş Ada Otel Bozcaada",
        "Salkım Butik Otel",
        "Aliş Boutique Otel",
        "Surf Inn Gökçeada",
        "İntepe Poseidon",
        ...
        "Gümüş Otel Bozcaada",
        "Casaluna Hotel Alaçatı",
        "Egemen Butik Otel",
        "Buğra Alaçatı",
        "Uzunhan Otel",
        "Uzun Apart Otel",
        "Soul of Alaçatı Beach Resort",
        "Armodies Thermal Park",
        ...
        "Anelli Hotel Antalya ",
        "Melanippe Relaxing Hotel  ",
        "Ayhan Hotel",
        "Kupina Alaçatı ",
        "Mells Alaçatı ",
        "Taşdelen Alaçatı",
        ...
        "Alados Hotel",
        "Hillcity Hotel Kaş",
        "Merla Kaş Villa Otelleri",
        "Çınar Boutique Hotel",
        "Espina Hotel",
        "Niss Lara Hotel",
        "Oleander Kaş Hotel",
        "Lara World Hotel",
        ...
        "Teras Butik Apart",
        "Majeste Hotel",
        "Turunç Bay Conti Boutique Hotel",
        "Golden Life Vento",
        "Golden Life Sand / Karavan",
        "Levent Hotel Fethiye",
        "Hera Hotels Çeşme",
        "Hotel Silvanus",
        "Premium Sapanca Resort",
        "Kasaba Butik Otel",
        ...
        "Hotel Cappa",
        "Işıl Suit Apart",
        "Emin Koçak Kapadokya Termal Hotel",
        "Golden Life Blue Green & Pasham Hotel",
        "Sena Hotels",
        "Mr.Dim Exclusive Apart Otel",
        "Panormos Hotel",
        "Maison Bahar Suites",
        "Demir Suit Hotel",
        "Dm Hotel Marmaris",
        ...
        "Alfa Apart",
        "Saranda Butik Otel",
        "Dibek Homes Villa & Hotel",
        "Monna Roza Family Suit",
        "Düven Hotel Cappadocia",
        "Oza Butik Otel",
        "Zeytinli Konak Otel Mordoğan",
        "Nilüfer Otel",
        "Cunda Ayla Boutique Hotel",
        "Sevo Hotel",
        "Efsanem Hotel",
        "Cunda Aşiyan Pansiyon",
        "Kinzi House",
        "Zeytindalı Apart&Pansiyon",
        "Elly's Home",
        "Volans Suites",
        "Assos Terrace Hotel",
        "Çeşme Kale Taş Apart",
        "Yenice Vadi",
        "Aloria Garden Hotel",
        ...
        "Kaş Olympos Mocamp",
        "Kuba Beach Hotel",
        "Karina Vineyard House",
        "A Diamond Hotel Sapanca",
        "Sapanca Aqua Hotel",
        "Kemer Residence 2",
        "Lighthouse Lilia Villa",
        "Faralya Gül Pansiyon",
        "Hora Konuk Evi",
        "Mic Royal Hotel",
        "Likya Pansiyon",
        "Aydeniz Apart Otel",
        ...
        "Sun & Sea Beach Hotel",
        "Hotel Dalos Göcek",
        "Şirince Doğadaki Evler",
        "Villa Vista Belek",
        "Kazdağları Karye Müze Otel",
        "Carmina Hotel",
        "Ece Butik Hotel - Şövalye Adası",
        "Doğa Hotel Ölüdeniz",
        "Büyükada My Way Butik Otel",
        "Elitpark Residance",
        "Turkuaz Köy",
        "Villa Bade Otel Alaçatı",
        ...
        "Yıldız Otel",
        "İntermar Hotel Marmaris",
        "Delfi Hotel Spa & Wellness",
        "Fiorita Beach Otel",
        "Santa Marina Hotel",
        "Hotel Villa Turka",
        "Voswos Garage Coffee Hotel",
        ...
        "Crystal Sunhill Resort & Spa",
        "Pera Hotel Alanya",
        "Dalyan Nish Caria Boutique Hotel",
        ...
        "La Mira Suites Hotel Alaçatı",
        "Vinifera Hotel Yedibilgeler Vineyards",
        "Hotel Green Gold",
        "Life Point Boutique Hotel",
        "Ayanya Beach",
        "Sandima Boutique Hotel",
        "Avrasya Termal Otel",
        "Akman Butik Otel",
        "Zübeyde Hanım Alaçatı Otel",
        "Süral Saray Hotel",
        "Süral Resort Hotel",
        "Süral Hotel",
        "Süral Garden Hotel",
        "Ada Marin Hotel",
        "Antik Manastır Otel",
        "Abant Bahçeli Köşk Otel",
        "Demisos Caves Hotel",
        "Aska Just In Beach",
        "Aska Lara Resort & Spa",
        "Capiedra Hotel",
        "Alaçatı Fora Konak",
        "Alacaat Otel Alaçatı ",
        "Room Room Motel",
        "Marina Hotel Bodrum",
        "Marmaris Bay Resort By Mp Hotels",
        "Holiday & Leisure Club Kuşadası",
        "Linda Expo Palace ",
        ...
        "Kabak Armes Hotel",
        "Bir Kedi Villa",
        "Tepe Hotel & Beach Club",
        "Cunda Şira Otel",
        "Cundavilla Suit Otel",
        "Slow West Glamping",
        "Yaprak Otel",
        "Cappadocia Eagle Cave Inn",
        "Ağva Mi Norte Boutique & Exclusive  ",
        "Ayvalık Moda Pansiyon",
        "Flash Otel Marmaris",
        "Grand Güllük Hotel",
        "Belgin Otel",
        "Happy Apart Hotel",
        ...
        "Sirena Apart & SPA",
        "ÇamlıVilla",
        "Büyükada Comfort Hotel",
        "Pavel'in Yeri Butik Otel",
        "Tayfun Hotel",
        "Moonlight Hotel",
        "Hazz Oda Otel Alaçatı",
        "Belek Soho Beach Club",
        "Demirci Hotel",
        "Seray Class Hotel & Apartments",
        "Koz Marigold Apart Otel",
        "Mavi Köşk Apart Hotel",
        "Şirince Klaseas Hotel",
        "Mountain Lodge",
        "Cappadocia Ennar Cave House",
        "Aycan Otel",
        "Aroma Butik Hotel",
        "Akyaka Gümüş Konakları",
        "Cappadocia Symbol Hotel",
        "Happy Family Apart",
        "Çeşme Köy Otel",
        "Ege Birlik Boutique",
        "Bozburun Pembe Yunus Hotel",
        "Turkuaz Pansiyon",
        "Gravel Hotels",
        "Abant Villa Otel",
        "Cennet Apart",
        ...
        "Hakan Hotel",
        "Portofino Boutique Hotel",
        "Adrasan La Casita Hotel",
        "Sığacık Marina Apart Hotel",
        "Patio Hotel",
        "Laledan Konağı Butik Hotel",
        ...
        "Nergiz Butik Hotel",
        "Kadir's Family Houses",
        "Temuçin Otel",
        "Nil Hotel Sarımsaklı",
        "Kaktüs Boutique Hotel Side",
        "Star Hotel Fethiye",
        "Gelos Pansiyon",
        "Koyunbaba Pansiyon Gümüşlük",
        "Lara Hotel",
        "Marin Yalıkavak Hotel ",
        "Karlık Cave Suite",
        "House Butik Otel",
        "Umut Pansiyon Selimiye",
        "Afet Hanım Konağı",
        "Semedan Apart Otel",
        "Kamelya Otel Selimiye",
        "Antique Hotel",
        "Villa Kaş Bohem",
        "Pürhayal Pansiyon",
        "Aydeniz Otel",
        ...
        "Kuşadası Rezidans",
        "Artı Butik Otel",
        "Ala Otel Konuk Evi Ağva",
        "Natural Pansiyon",
        "Artı Şahin Apart Otel",
        "Mono Hotel",
        "Miramar Hotel",
        "Amanruya  Otel",
        "Acem Hotel",
        ...
        "Hotel Grand Azmakhan Spa&Wellness ",
        "Kanelo Otel Ayvalık",
        "Boheme Bleue Sığacık",
        "Wings Cappadocia Hotel",
        "Bera Alanya Otel",
        ...
        "Cunda Rota Otel",
        "Larissa Hill Beach",
        "Golden Beach Deluxe Hotel",
        "Hotel Pop Alaçatı",
        "Mavi İnci Park Otel",
        "Çetin Prestige Resort",
        "Grand Ata Park Hotel",
        "Perla Otel İzmir",
        "Etap Altınel Çanakkale",
        "Club Resort Atlantis",
        "The Sign Şile Hotel & Spa",
        "Blue Bay Platinum",
        "Blue Wave Suite Hotel",
        "Casa Margot Hotel",
        "Kahveci Alibey Hotel",
        ...
        "Alaroof Butik Otel",
        "Sarı Gelin Butik Hotel",
        "Akkan Beach Hotel",
        "Balambaka Butik Otel",
        "Gönülhan Otel Alaçatı",
        "Kayezta Otel Alaçatı",
        "La Mia Casa Hotel",
        ...
        "Hotel Twenty Kaleiçi",
        "Adadayız by YAVUZ",
        "Petunya Konak Butik Otel",
        "Only Blue",
        "Martı Pansiyon",
        "Myndos Bed & Breakfast Gümüşlük",
        "Flamingo Residence",
        "Villa Kırkpınar",
        "Gün Ay Hotel Gümbet",
        "Mara Palace Hotel",
        ...
        "Mervehan Residance ",
        "Lyra Resort Hotel",
        "Goddess Of Bodrum İsis Hotel & Spa",
        "Sun Life Resort Hotel",
        "Lemon Garden By Yazıcı",
        "Aymesev Çeşme",
        "L Hotel Sarıgerme",
        "Aksu Alaçatı",
        "128A Hotel Alaçatı",
        "Green Boutique Hotel",
        "Melisa Bungalow Otel",
        "Hekatonisa Otel",
        "Tema Lara Apart",
        "Skull Alaçatı Boutique Hotel",
        "Ağva My Dream Hotel",
        "Blue Bay Beach Hotel",
        "Sea Bird Hotel",
        "Bumerang Suites Hotel",
        "The Elysium Yalıkavak Bodrum",
        "Bir Butik Otel",
        "Mara Köyiçi Alaçatı",
        "İmza Otel Alaçatı ",
        "Dionisus Hotel",
        ...
        "Pirate's Beach Club",
        "Royal Nas Resort",
        "Denizyıldızı Hotel Bozcaada ",
        "Tunan Motel",
        "Çıralı Marina Loft",
        "Yalı Apart Bodrum",
        "Skopea İnn Exclusive",
        "IC Hotels Residence",
        "Minerva Port Hotel",
        "Parli Hotel",
        ...
        "Yunus Hotel Fethiye",
        "Eliz Apart Bodrum",
        "Rüya Butik Otel Selimiye",
        "Mira Suites Otel",
        "Misket Hotel Bodrum",
        "Grand Cettia Hotel",
        "Green Hills Suites",
        "Eriş Hotel Bodrum",
        "Time To Smile Mavi Hotel & Residence",
        "Belek'te Ultra Her Şey Dahil Yaz Fırsatları",
        "Belek'te Her Şey Dahil Yaz Fırsatları",
        "Mets Boutique Hotel",
        "Ölüdeniz Blu Luxury Unique Hotel",
        "Club Cettia All Suites",
        "Dobra Hotel",
        ...
        "Susona Bodru,LXR Hotels & Resorts",
        "TrendBlue Boyalık",
        "Cynara Otel Alaçatı ",
        "Gold Kaya Otel",
        "Gold Butik Otel",
        ...
        "Şifne Termal Otel",
        "Villa Florya Otel Kumlubük",
        "Yiva Otel Kazdağları",
        "The Mori Club Hotel",
        ...
        "Perlacia Hotel & Suit",
        "Casa Sur Antalya",
        "Aja Cappadocia Hotel",
        "Sapanca Villa Suite",
        "Assos Hotel ",
        "Jura Hotels Afyon Thermal",
        "Bonjo Club Resort",
        "Urga Butik Otel",
        "Airport Güllük Hotel",
        "Güllük Life Otel",
        "Mimoza Apart Güllük",
        "Abant Doğa Köşkü",
        ...
        "Moyo Luxury Boutique Hotel & Beach",
        "Vega Boutique & Aparts",
        ...
        "MYSTIC KONAK ŞİRİNCE",
        "Club Throne Beach",
        "Grand Emir Aqua Resort & Spa",
        "Dublex Dağ Evi",
        ...
        "Rue d’Azur Alaçatı",
        "Oberj d’Azur Alaçatı",
        "Meydan d’Azur Alaçatı ",
        "Urla Sardunya Apart Otel",
        ...
        "Unique Life Style Otel",
        "Baleze Boutique Hotel",
        "Atıcı Hotel",
        "Phoenix Sun Hotel",
        "Alaçatı Alayaz Otel",
        "Alaçatı Gerence Otel",
        "Gülce Art Boutique Hotel",
        "Foça Monk Island Guesthouse",
        "Sunpoint Family Hotel",
        "Hotel Azmakhan",
        "Green Garden Resort Hotel",
        "İskelem  Otel",
        "Provence Mansion Alaçatı",
        "Kuluhana Hotel & Villas Kalkan",
        "Suess Alaçatı",
        "Ören Konak Apart",
        "Gümüş Peninsula Hotel",
        "Urla 1870’s Taş Konak Otel",
        ...
        "Lord Marina Otel",
        "Palmen Apart Otel",
        "Ölüdeniz Beach Resort by Z Hotels",
        "Akyaka Viya Otel",
        " Bramasole Butik Otel  Alaçatı",
        "Inca Boutique",
        "Palm Inn Hotel",
        "Surya Butik Hotel",
        "Mavi Melek Otel  Selimiye",
        "Lime Bozcaada",
        "Orino Suites",
        "Lemon Garden Butik Otel",
        "Dolphin Hotel Bozburun",
        "Villa Fokai Otel",
        "Otello Alaçatı",
        "Mini Star Hotel",
        "Bergama Taşkonak",
        "Larina Ninova Thermal Hotel",
        "Larina Thermal Hotel",
        "Larina Vista Wellness Spa Hotel",
       ...
       var html = `<div class="smpl-hopi-banner" style="margin-bottom:10px;"><a href="https://www.setur.com.tr/hopi-paracik-kampanyasi" target="_blank"><img class="smpl-hopi" style="height: 55px;" src="https://cdn.8digits.com/log/r/1fe08fc5-4615-4284-b741-9af84eccb1b0.jpeg"></a></div>`;
         hotelList.forEach(function (item) {
            if(jQuery(".hotel-detail-name").text().trim() === item){
                if(jQuery(".smpl-odemeBanner-tooltip-container").length > 0){
                    jQuery(".smpl-odemeBanner-tooltip-container").before(html);
                    EightDigits.analytics.sendEvent(config.analytics, "shown_banner");
                }else {
                    jQuery(".content-partial-shadow.price-partial-shadow.display-only-mobile").eq(1).after(html)
                    EightDigits.analytics.sendEvent(config.analytics, "shown_banner");
                }
            }
          })
    ...
    var _ed_Hopi_Detay_Banner_Mobile = new EightDigits.sf();
    _ed_Hopi_Detay_Banner_Mobile.Hopi_Detay_Banner_Mobile();
  })();
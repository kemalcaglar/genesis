...
(function () {
    if (EightDigits.sf.prototype.hasOwnProperty("Homepage_Story_Desktop")) {
        return false
    }
    EightDigits.sf.prototype.Homepage_Story_Desktop = function () {

        var config = {
            scenarioname: "Homepage_Story_Desktop",
            analytics: "homepageStories",
            tag:"",
            controlgroup: 0
        };
        ...
        main.factory.prototype = {
            ...
            start: function () {
                ...
                var campaigns = [
                    {
                        ...
                        imgBig: "",
                        url: "https://www.setur.com.tr/kemer-otelleri?true&ref=story"
                ...
                var stories = '<div id="ed_webstories_main" style="width:100%;display:flex;justify-content:center;margin-bottom: -30px;margin-top: 30px;">\
                ...
                jQuery(".top-area.show-onload").after(stories);
    ...
    var _ed_Homepage_Story_Desktop = new EightDigits.sf();
    _ed_Homepage_Story_Desktop.Homepage_Story_Desktop();
})();
(function () {
    if (EightDigits.sf.prototype.hasOwnProperty("Hopi_Listeleme_Banner_Mobile")) {
        return false
    }
    EightDigits.sf.prototype.Hopi_Listeleme_Banner_Mobile = function () {
        var config = {
            scenarioname: "Hopi_Listeleme_Banner_Mobile",
            analytics: "Hopi_Listeleme_Banner_Mobile",
            controlgroup: 0
        };
        var main = {
            "factory": function () {
            ...
            start: function () {
                var hotelList = [
                  ...
                  jQuery(".booking-item").map(function () {
                    ...
                    var hotelName = jQuery(this).find("h3").eq(0).text().trim();
                    if (hotelList.indexOf(hotelName) > -1) {
                      jQuery(this).append("<a href='https://www.setur.com.tr/hopi-paracik-kampanyasi' target='_blank'><img class='smpl-hopi-banner' style='margin-top:-44px; height:34px; width:187px; left:10px; position:absolute;' src='https://cdn.8digits.com/log/r/29d9dcd5-f30b-4ad9-aea1-fbaa425f1d8c.jpeg'></a>")
    ...
    var _ed_Hopi_Listeleme_Banner_Mobile = new EightDigits.sf();
    _ed_Hopi_Listeleme_Banner_Mobile.Hopi_Listeleme_Banner_Mobile();
  })();
(function () {
    if (EightDigits.sf.prototype.hasOwnProperty("Zeynep_Hotel_Banner")) {
        return false
    }
    EightDigits.sf.prototype.Zeynep_Hotel_Banner = function () {
        var config = {
            scenarioname: "Zeynep_Hotel_Banner",
            analytics: "Zeynep_Hotel_Banner",
            controlgroup: 0
        };
        var main = {
            "factory": function () {
        ...
        main.factory.prototype = {
            ...
            start: function () {
                ...
                .smpl-tooltips{display: none; padding: 10px; background: #555; border-radius: 10px; color: #c4c4c4; position: absolute; bottom: -195px; box-shadow: 1px 1px 3px 1px rgba(0,0,0,0.1);animation:one 1s;-webkit-animation:one 1s;-moz-animation:one 1s;-o-animation:one 1s;-ms-animation:one 1s;}\
                ...
                jQuery('head').append(css);
                var html = '<div id="smpl-banner zeynep-tooltip-area">\
            ...
            ">\
                ...
                <img src="https://cdn.8digits.com/log/r/b94bc3a9-97e1-45d0-924f-9090d3a7599c.jpeg">\
                </div>\
                '
                jQuery(".content-partial-shadow").eq(4).after(html);
                EightDigits.analytics.sendEvent(config.analytics, "shown-banner");
                jQuery(".smpl-zeynep-button").hover(function(){
                ...
                jQuery(".smpl-zeynep-button").mouseout(function(){
    ...
    var _ed_Zeynep_Hotel_Banner = new EightDigits.sf();
    _ed_Zeynep_Hotel_Banner.Zeynep_Hotel_Banner();
  })();
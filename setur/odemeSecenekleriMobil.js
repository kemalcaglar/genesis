          ...
          start: function () {
            if (jQuery(".ed-cancelInfoMain").length > 0) {
              var html = `<div class="ed-cancelInfoMain">
                ...
                <a href="https://www.setur.com.tr/diledigin-odeme-seklini-sec"> <img src="https://cdn.8digits.com/log/r/1512b404-5518-413a-b410-b2f8126f50f1.jpeg"></a>
                </div> 
               </div>`
            ...
            jQuery("#ed-cancelInfoMain").click(function() {
                EightDigits.analytics.sendEvent(config.analytics, "Click_Banner_Odeme");
            })
          },
          control: function () {
          },

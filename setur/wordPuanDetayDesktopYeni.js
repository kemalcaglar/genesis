(function () {
    if (EightDigits.sf.prototype.hasOwnProperty("Hopi_Detay_Banner_Desktop")) {
        return false
    }
    EightDigits.sf.prototype.Hopi_Detay_Banner_Desktop = function () {
        var config = {
            scenarioname: "Hopi_Detay_Banner_Desktop",
            analytics: "Hopi_Detay_Banner_Desktop",
            controlgroup: 0
        };
        var main = {
            "factory": function () {
    ...
    var hotelList = [
       ...
       hotelList.forEach(function (item) {
           if(jQuery(".hotel-detail-name").text().trim() === item){
             var html = `<div class="smpl-hopi-banner"><a href="https://www.setur.com.tr/hopi-paracik-kampanyasi" target="_blank"><img class="smpl-hopi" src="https://cdn.8digits.com/log/r/1fe08fc5-4615-4284-b741-9af84eccb1b0.jpeg"></a></div>`;
    ...
    var _ed_Hopi_Detay_Banner_Desktop = new EightDigits.sf();
    _ed_Hopi_Detay_Banner_Desktop.Hopi_Detay_Banner_Desktop();
  })();
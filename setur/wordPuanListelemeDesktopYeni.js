(function () {
    if (EightDigits.sf.prototype.hasOwnProperty("Hopi_Listeleme_Banner_Desktop")) {
        return false
    }
    EightDigits.sf.prototype.Hopi_Listeleme_Banner_Desktop = function () {
        var config = {
            scenarioname: "Hopi_Listeleme_Banner_Desktop",
            analytics: "Hopi_Listeleme_Banner_Desktop",
            controlgroup: 0
        };
        var main = {
            "factory": function () {
                ...
                var hotelList = [
                  ...
                  jQuery(".hotellist-item-information").map(function () {
                    ...
                    if (hotelList.indexOf(hotelName) > -1) {
                      jQuery(this).append("<a href='https://www.setur.com.tr/hopi-paracik-kampanyasi' target='_blank'><img class='smpl-hopi-banner' style='margin-top:20px; height:34px; width:187px;' src='https://cdn.8digits.com/log/r/29d9dcd5-f30b-4ad9-aea1-fbaa425f1d8c.jpeg'></a>")
    ...
    var _ed_Hopi_Listeleme_Banner_Desktop = new EightDigits.sf();
    _ed_Hopi_Listeleme_Banner_Desktop.Hopi_Listeleme_Banner_Desktop();
  })();
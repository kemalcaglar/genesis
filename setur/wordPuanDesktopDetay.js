  ...
  var hotelList = [
     ...
     hotelList.forEach(function (item) {
         if(jQuery(".hotel-detail-name").text().trim() === item){
           var html = `<div class="smpl-word-banner"><a href="https://www.setur.com.tr/setur-world-puan-kampanyasi" target="_blank"><img class="smpl-word" src="https://cdn.8digits.com/log/r/f99313e6-c957-442e-8659-6e65a72808d6.jpeg"></a></div>`;

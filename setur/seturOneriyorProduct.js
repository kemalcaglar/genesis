(function () {
  EightDigits.sf.prototype.Setur_Oneriyor_Badge_Product = function () {


      var config = {
          scenarioname: "Setur_Oneriyor_Badge_Product",
          analytics: "Setur_Oneriyor_Badge_Product",
          controlgroup: 0
      };
      ...
      main.factory.prototype = {
          ...
          start: function () {
              ...
              html = `
              <div id="ed_suggestion_desktop" style="position: absolute;
              bottom: 10px;
              left: 10px;
              width: 122px;
              height: 32px;
              ...
              `
                ...
                let isHotelMatch = jQuery(".hotel-detail-name").text().trim()
                if( selectedOtels.includes(isHotelMatch)){
                    if (window.innerWidth > 576) {
                        jQuery(".fotorama__stage").append(html)
  ...
  var _ed_Setur_Oneriyor_Badge_Product = new EightDigits.sf();
  _ed_Setur_Oneriyor_Badge_Product.Setur_Oneriyor_Badge_Product();
})();

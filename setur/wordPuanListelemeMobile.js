var hotelList = [
  ...
  jQuery(".booking-item").map(function () {
    ...
    if (hotelList.indexOf(hotelName) > -1) {
      jQuery(this).append("<img class='smpl-word-banner' style='margin-top:-44px; height:34px; width:187px; left:10px; position:absolute;' src='https://cdn.8digits.com/log/r/0587ba7c-cc41-427c-bd39-aa8a372017da.jpeg'>")

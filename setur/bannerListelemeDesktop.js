  ...
  EightDigits.sf.prototype.hotelListingCancelBar = function () {
      ...
      main.factory.prototype = {
          ...
          start: function () {
              ...
              .smpl-arrow-right{width: 0;height: 0;border-top: 10px solid transparent;border-bottom: 10px solid transparent;border-left: 10px solid #555!important;position: absolute;right: 3%;margin-top: -105px;display:none;transform: rotate(90deg);-webkit-transform: rotate(90deg);}\
      </style>'
      jQuery('head').append(css)
              jQuery('#Hotel-List-Container ul li:eq(0)').after('<div class="ed-cancelInfoMain"><div id="ed-cancelInfo" style="width: 100%;margin-bottom: 20px;"><img src="https://cdn.8digits.com/log/r/03fc662d-ee94-4e6c-90e1-88f79a2d9cbf.png"></div><div class="smpl-arrow-right"></div>\

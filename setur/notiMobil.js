        ...
        main.factory.prototype = {
            ...
            start: function () {
                    ...
                    var data = [{
                        id: '',
                         ...
                         }, 
                         {
                          ...
                          {
                        id: '',
                        title: '250 TL Worldpuan Kampanyası',
                      ...
                      {
                          id: '',
                          title: 'Ücretsiz Geceleme Fırsatları',
                          url: 'https://www.setur.com.tr/1-gece-bizden-kampanyasi',
                        },, 
                       {
                        id: '',
                ...
                if (jQuery('.fas.fa-user-check.js-userBtn').length===0) {
                    html = '\
                        <div class="menu-items-level-1" id="icon-notification-8d" style="position: absolute; top: -17px; height: 38px; z-index: 99999; width: 40px; cursor: pointer; margin-left: 27px; display: block; background-position: 0px 0px;">\
                    ...
                    ';
                    jQuery('.top-user-area .login-button').append(html); // login değilse
                }
                else {
                    html = '\
                        <div class="menu-items-level-1" id="icon-notification-8d" style="position: absolute; top: -11px; height: 38px; z-index: 99999; width: 40px; cursor: pointer; margin-left: 27px; display: block; background-position: 0px 0px;">\
                        <i class="fa fa-bell" style="margin-top:6px;font-size: 26px;color: #e5252d;" ;=""></i>\
                            <span class="_ed_count" style="position: absolute;color: #fff;font-weight: bold;height: 18px;width: 18px;line-height: 10px;top: 2px;left: 18px;border: 1px solid #ffffff;border-radius: 50%;background-color: #616161;padding-left: 5px;padding-top: 3px;">' + dl + '</span>\
                        </div>\
                    ';
                    jQuery('.top-user-area').append(html); // loginse
                }
                setTimeout(function () {
                    ...
                    if (randomControlVal < 9000) {
                        ...
                        var data = [{
                          ...
                          },
                          {
                           ...
                           {
                            id: '',
                            title: 'İstegelsin’de 30 TL indirim',
                            url: 'https://www.setur.com.tr/setur-istegelsin-kampanyasi',
                          },
                          ];
                    } else {
                        EightDigits.analytics.sendEvent(config.analytics, "NotShown");

...
'Foça Kumsal Hotel',
      ...
      main.factory.prototype = {
          ...
          start: function () {
              ...
              .ed_'+ config.scenarioname + '_smpl-tooltip{position: absolute;width: 200px;right: 0;margin-top: -190px;border-radius: 6px;padding: 4px 5px;background-color: #555!important;z-index:99;display:none;}\
              ...
              .smpl-arrow-right{width: 0;height: 0;border-top: 10px solid transparent;border-bottom: 10px solid transparent;border-left: 10px solid #555!important;position: absolute;right: 5%;margin-top: -90px;display:none;transform: rotate(90deg);-webkit-transform: rotate(90deg);}\
      </style>'
      jQuery('head').append(css)

              jQuery('.content-partial-shadow.price-partial-shadow.display-only-mobile:eq(0)').after('<div class="ed-cancelInfoMain"><div id="ed-cancelInfo" style="width: 100%;margin-bottom: 10px; margin-top:10px"><img src="https://cdn.8digits.com/log/r/48154727-8135-4120-9836-ed9b647d4111.png"></div><div class="smpl-arrow-right"></div>\

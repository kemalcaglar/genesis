    ...
    EightDigits.sf.prototype.Rezervasyon_Ucus_BannerM = function () {
        ...
        main.factory.prototype = {
            ...
            start: function () {
             ...
             border: 2px dashed #336da7;\
             margin-top: 20px;\
             background: #4aa5ff;\
             color: #fefefe;\
             height: auto;\
             "><i class="fas fa-exclamation-triangle fa-3x" style="position: absolute;margin-top: 15px;margin-left: 10px;"></i><span style="\
             position: relative;\
             margin-left: 65px;\
             ...
             font-size: 12px;\
             line-height:1.4em;\
             ">29 Nisan 19:00 - 17 Mayıs 05:00 saatleri </br> arasında yapılacak yurtiçi uçuşları için</br> Seyahat izin Belgesi gerekmektedir.</span></div>\
             '

(function () {
  if (EightDigits.sf.prototype.hasOwnProperty("Word_Listeleme_Banner_Desktop")) {
      return false
  }
  EightDigits.sf.prototype.Word_Listeleme_Banner_Desktop = function () {
      var config = {
          scenarioname: "Word_Listeleme_Banner_Desktop",
          analytics: "Word_Listeleme_Banner_Desktop",
          controlgroup: 0
      };
      var main = {
          "factory": function () {
      ...
      main.factory.prototype = {
          ...
          start: function () {
              var hotelList = [
                ...
                jQuery(".hotellist-item-information").map(function () {
                
                  var hotelName = jQuery(this).find("h3").text().trim();
                  if (hotelList.indexOf(hotelName) > -1) {
                    jQuery(this).append("<img class='smpl-word-banner' style='margin-top:20px; height:34px; width:187px;' src='https://cdn.8digits.com/log/r/0587ba7c-cc41-427c-bd39-aa8a372017da.jpeg'>")
                    EightDigits.analytics.sendEvent(config.analytics, "shown_banner")
                }
                });
              <a href='https://www.setur.com.tr/setur-world-puan-kampanyasi' target='_blank'></a>
          },
          control: function () {
          },
          init: function () {
  ...
  var _ed_Word_Listeleme_Banner_Desktop = new EightDigits.sf();
  _ed_Word_Listeleme_Banner_Desktop.Word_Listeleme_Banner_Desktop();
})();
        ...
        "Kocca Ev",
         ...
         hotelList.forEach(function (item) {
            if(jQuery(".hotel-detail-name").text().trim() === item){
                var html = `<div class="smpl-word-banner" style="margin-bottom:10px;"><img class="smpl-word" style="height: 55px;" src="https://cdn.8digits.com/log/r/f99313e6-c957-442e-8659-6e65a72808d6.jpeg"></div>`;

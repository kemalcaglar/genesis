(function () {
  if (EightDigits.sf.prototype.hasOwnProperty("Product_Credit_Mobile")) {
      return false
  }
  EightDigits.sf.prototype.Product_Credit_Mobile = function () {
      var config = {
          scenarioname: "Product_Credit_Mobile",
          analytics: "Product_Credit_Mobile",
          controlgroup: 0
      };
      var main = {
          "factory": function () {
      ...
      main.factory.prototype = {
          ...
          start: function () {
            ...
            arrProductHotel.forEach(function (item) {
              if(jQuery(".hotel-detail-name").text().trim() === item){
                var html = `<div class="smpl-taksit-banner"><i class="far fa-credit-card" style="color:white;"></i>
                <span class="smpl-taksitBanner-text">Taksitleri 4 ay ertele</span>
                <a href="https://www.setur.com.tr/taksitleri-4-ay-erteleme-kampanyasi" target="_blank"><span class="smpl-taksitBanner-btn">DETAYLAR</span></a></div>`;
                jQuery(".content-partial-shadow").eq(3).before(html);
              }
            })
          },
          control: function () {
  ...
  var _ed_Product_Credit_Mobile = new EightDigits.sf();
  _ed_Product_Credit_Mobile.Product_Credit_Mobile();
})();
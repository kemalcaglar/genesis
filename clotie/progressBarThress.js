...
let questionGroup = {
  ...
  groupTwoGirl:[
    "Omzunu nasıl tanımlarsın?",
    "Karın yapını nasıl tanımlarsın?",
    "Kalça yapını nasıl tanımlarsın?",
    ...
    "Jean/pantolon belini hangi yükseklikte tercih edersin?",
    "Jean/pantolon belini hangi yükseklikte tercih edersin?",
    "Hangi etek boyunu tercih edersin?",
    "Vücudunda vurgulamak veya gizlemek istediğin bölgeler var mı?",
  ...
  groupThreeGirl: [
    "Genellikle hangi tonlarda giyinirsin?",
    'Seçimlerimizde kesinlikle istemediğin renkler var mı?',
    'Seçimlerimizde kesinlikle istemediğin takı renkleri var mı?',
    'Seçimlerimizde kesinlikle istemediğin yaka türleri var mı?',
    'Seçimlerimizde kesinlikle istemediğin desenler var mı?',
    'Seçimlerimizde kesinlikle istemediğin dokular var mı?',
    'Seçimlerimizde kesinlikle istemediğin ürünler var mı?',
...
const addDiscountBanner = smplObj.debounce(function () {
  ...
  for (let index = 0; index < questionGroup.groupTwoGirl.length; index++) {
    if (questionGroup.groupTwoGirl[index] == questionText) {
      progressWidth = ((index + 1) * 1.72) + 24;
      changeProgress(progressWidth);
      if (progressWidth > 24) {
        document.getElementById('circle-two').style.backgroundColor = '#504566'; //parent kullan
        document.getElementById('circle-two-span').style.display = 'none';
  ...
  for (let index = 0; index < questionGroup.groupThreeGirl.length; index++) {
    if (questionGroup.groupThreeGirl[index] == questionText) {
      progressWidth = ((index + 1) * 2.375) + 43;
      changeProgress(progressWidth);
      if (progressWidth > 24) {
        document.getElementById('circle-two').style.backgroundColor = '#504566'; //parent kullan
        document.getElementById('circle-two-span').style.display = 'none';

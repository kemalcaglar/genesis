...
<div id="circle-one" class="bg smpl-circle circle-one" data-v-104ab626="">
<svg id="circle-one-svg" width="30" height="20" viewBox="0 0 24 24" fill="#fff" xmlns="http://www.w3.org/2000/svg" data-v-104ab626="" style="display: block;">
...
<span id="circle-one-span" class="circle-span" style="display: none; data-v-104ab626=""> 1 </span>
</div>
<div id="circle-two" class="bg smpl-circle circle-two" data-v-104ab626="">
<svg id="circle-two-svg" width="30" height="20" viewBox="0 0 24 24" fill="#fff" xmlns="http://www.w3.org/2000/svg" data-v-104ab626="" style="display: none;">
<path d="M19.0747 8.30739C19.6294 7.75269 19.631 6.85383 19.0783 6.29717C18.5228 5.73772 17.6184 5.73612 17.0609 6.2936L8.69269 14.6618L6.01098 11.9905C5.456 11.4377 4.55821 11.4385 4.00431 11.9924C3.44964 12.5471 3.44964 13.4464 4.00431 14.001L7.98558 17.9823C8.37611 18.3728 9.00927 18.3728 9.3998 17.9823L19.0747 8.30739Z" data-v-104ab626=""></path></svg>
<span id="circle-two-span" class="circle-span" data-v-104ab626=""> 1 </span>
</div>
<div id="circle-three" class="bg smpl-circle circle-three" data-v-104ab626="">
<svg id="circle-three-svg" width="30" height="20" viewBox="0 0 24 24" fill="#fff" xmlns="http://www.w3.org/2000/svg" data-v-104ab626="" style="display: none;">
<path d="M19.0747 8.30739C19.6294 7.75269 19.631 6.85383 19.0783 6.29717C18.5228 5.73772 17.6184 5.73612 17.0609 6.2936L8.69269 14.6618L6.01098 11.9905C5.456 11.4377 4.55821 11.4385 4.00431 11.9924C3.44964 12.5471 3.44964 13.4464 4.00431 14.001L7.98558 17.9823C8.37611 18.3728 9.00927 18.3728 9.3998 17.9823L19.0747 8.30739Z" data-v-104ab626=""></path></svg>
<span id="circle-three-span" class="circle-span" data-v-104ab626=""> 2 </span>
</div>
<div id="circle-four" class="bg smpl-circle circle-four" data-v-104ab626="">
<svg id="circle-four-svg" width="30" height="20" viewBox="0 0 24 24" fill="#fff" xmlns="http://www.w3.org/2000/svg" data-v-104ab626="" style="display: none;">
<path d="M19.0747 8.30739C19.6294 7.75269 19.631 6.85383 19.0783 6.29717C18.5228 5.73772 17.6184 5.73612 17.0609 6.2936L8.69269 14.6618L6.01098 11.9905C5.456 11.4377 4.55821 11.4385 4.00431 11.9924C3.44964 12.5471 3.44964 13.4464 4.00431 14.001L7.98558 17.9823C8.37611 18.3728 9.00927 18.3728 9.3998 17.9823L19.0747 8.30739Z" data-v-104ab626=""></path></svg>
<span id="circle-four-span" class="circle-span" data-v-104ab626=""> 3 </span>
</div>
<div id="circle-five" class="bg smpl-circle circle-five" data-v-104ab626="">
<svg id="circle-five-svg" width="30" height="20" viewBox="0 0 24 24" fill="#fff" xmlns="http://www.w3.org/2000/svg" data-v-104ab626="" style="display: none;">
<path d="M19.0747 8.30739C19.6294 7.75269 19.631 6.85383 19.0783 6.29717C18.5228 5.73772 17.6184 5.73612 17.0609 6.2936L8.69269 14.6618L6.01098 11.9905C5.456 11.4377 4.55821 11.4385 4.00431 11.9924C3.44964 12.5471 3.44964 13.4464 4.00431 14.001L7.98558 17.9823C8.37611 18.3728 9.00927 18.3728 9.3998 17.9823L19.0747 8.30739Z" data-v-104ab626=""></path></svg>
<span id="circle-five-span" class="circle-span" data-v-104ab626=""> 4 </span>
</div>
<div id="circle-six" class="bg smpl-circle circle-six" data-v-104ab626="">
<svg id="circle-six-svg" width="30" height="20" viewBox="0 0 24 24" fill="#fff" xmlns="http://www.w3.org/2000/svg" data-v-104ab626="" style="display: none;">
<path d="M19.0747 8.30739C19.6294 7.75269 19.631 6.85383 19.0783 6.29717C18.5228 5.73772 17.6184 5.73612 17.0609 6.2936L8.69269 14.6618L6.01098 11.9905C5.456 11.4377 4.55821 11.4385 4.00431 11.9924C3.44964 12.5471 3.44964 13.4464 4.00431 14.001L7.98558 17.9823C8.37611 18.3728 9.00927 18.3728 9.3998 17.9823L19.0747 8.30739Z" data-v-104ab626=""></path></svg>
<span id="circle-six-span" class="circle-span" data-v-104ab626=""> 5 </span>
</div>
</div>
...
const addDiscountBanner = smplObj.debounce(function () {
  ...
  for (let index = 0; index < questionGroup.groupTwo.length; index++) {
    if (questionGroup.groupTwo[index] == questionText) {
  ...
  for (let index = 0; index < questionGroup.groupThree.length; index++) {
    if (questionGroup.groupThree[index] == questionText) {
  ...
  for (let index = 0; index < questionGroup.groupFour.length; index++) {
    if (questionGroup.groupFour[index] == questionText) {
  ...
  for (let index = 0; index < questionGroup.groupFive.length; index++) {
    if (questionGroup.groupFive[index] == questionText) {

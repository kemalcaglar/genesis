(function () {
    if (EightDigits.sf.prototype.hasOwnProperty("Armani_Kulaklik_Hediye")) {
      return false
    }
    EightDigits.sf.prototype.Armani_Kulaklik_Hediye = function () {
      var config = {
        scenarioname: "Armani_Kulaklik_Hediye",
        analytics: "Armani_Kulaklik_Hediye",
        controlgroup: 0
      };
      var main = {
        "factory": function () {
      ...
      main.factory.prototype = {
        ...
        start: function () {
          ...
          if(window.innerWidth>768){
            ...
            position: absolute;bottom: 0;left:0px;width: 100%;padding: 2px;'>KULAKLIK HEDİYE</div>
            `;
            ...
            var html="<div style=' background-color: #1A1915;opacity: 0.85;letter-spacing: 1px;text-align: center;color: #FFFFFF;position: absolute;bottom: 0;width: 100%;font-size:12px;'>KULAKLIK HEDİYE</div>";
    ...
    var _ed_Armani_Kulaklik_Hediye = new EightDigits.sf();
    _ed_Armani_Kulaklik_Hediye.Armani_Kulaklik_Hediye();
  })();
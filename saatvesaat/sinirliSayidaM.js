(function () {
    if (EightDigits.sf.prototype.hasOwnProperty("Sinirli_Sayida_Product_Mobile")) {
      return false;
    }
    EightDigits.sf.prototype.Sinirli_Sayida_Product_Mobile = function () {
      var config = {
        scenarioname: "Sinirli_Sayida_Product_Mobile",
        analytics: "Sinirli_Sayida_Product_Mobile",
        controlgroup: 0,
      };
      var main = {
        factory: function () {
      ...
      main.factory.prototype = {
        ...
        start: function () {
          ...
          <div class="ed-sinirli-badge" style=" width: 100%; height: 27px; background-color: #1A1915; display: block; z-index: 9; "><p style=" text-align: center; font-size: 14px; line-height: 27px; color: #fff; ">SINIRLI SAYIDA</p></div>\
          </div>\
</a>'
    ...
    var _ed_Sinirli_Sayida_Product_Mobile = new EightDigits.sf();
    _ed_Sinirli_Sayida_Product_Mobile.Sinirli_Sayida_Product_Mobile();
  })();

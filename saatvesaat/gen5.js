      ...
      main.factory.prototype = {
        ...
        start: function () {
          ...
          if(window.innerWidth>768){
            ...
            position: absolute;bottom: 10px;left:7px;padding: 2px; display:flex; font-weight:bold;'>GEN 5</div>
            `;
            ...
            position: absolute;bottom: 0;left:7px;padding: 2px; display:flex; font-weight:bold; font-size:12px;'>GEN 5</div>";

(function () {
    if (EightDigits.sf.prototype.hasOwnProperty("Fosforlu_Badge_Category")) {
      return false
    }
    EightDigits.sf.prototype.Fosforlu_Badge_Category = function () {
      var config = {
        scenarioname: "Fosforlu_Badge_Category",
        analytics: "Fosforlu_Badge_Category",
        controlgroup: 0
      };
      var main = {
        "factory": function () {
      ...
      main.factory.prototype = {
        ...
        start: function () {
          ...
          if(window.innerWidth>768){
            ...
            position: absolute;bottom: 0;left:0px;width: 100%;padding: 2px;'>FOSFORLU</div>
            `;
            ...
            var html="<div style=' background-color: #1A1915;opacity: 0.85;letter-spacing: 1px;text-align: center;color: #FFFFFF;position: absolute;bottom: 0;width: 100%;font-size:12px;'>FOSFORLU</div>";
    ...
    var _ed_Fosforlu_Badge_Category = new EightDigits.sf();
    _ed_Fosforlu_Badge_Category.Fosforlu_Badge_Category();
  })();
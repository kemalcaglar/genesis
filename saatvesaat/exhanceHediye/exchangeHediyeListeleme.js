(function () {
  if (EightDigits.sf.prototype.hasOwnProperty("Exchange_Hediye_Listeleme")) {
    return false
  }
  EightDigits.sf.prototype.Exchange_Hediye_Listeleme = function () {
    var config = {
      scenarioname: "Exchange_Hediye_Listeleme",
      analytics: "Exchange_Hediye_Listeleme",
      controlgroup: 0
    };
    var main = {
      "factory": function () {
    ...
    main.factory.prototype = {
      ...
      start: function () {
        ...
        if(window.innerWidth>768){
          var html=`<div class='smpl-exchange-badge' style='background-color: #1A1915;opacity: 0.85;letter-spacing: 1px;text-align: center;color: #FFFFFF;
  ...
  var _ed_Exchange_Hediye_Listeleme = new EightDigits.sf();
  _ed_Exchange_Hediye_Listeleme.Exchange_Hediye_Listeleme();
})();
(function () {
    if (EightDigits.sf.prototype.hasOwnProperty("SinirliSayidaBadgeCategory")) {
      return false
    }
    EightDigits.sf.prototype.SinirliSayidaBadgeCategory = function () {
      var config = {
        scenarioname: "SinirliSayidaBadgeCategory",
        analytics: "SinirliSayidaBadgeCategory",
        controlgroup: 0
      };
      var main = {
        "factory": function () {
      ...
      main.factory.prototype = {
        ...
        start: function () {
          ...
          if(window.innerWidth>768){
            ...
            position: absolute;bottom: 0;left:0px;width: 100%;padding: 2px;'>SINIRLI SAYIDA</div>
            `;
            ...
            var html="<div style=' background-color: #1A1915;opacity: 0.85;letter-spacing: 1px;text-align: center;color: #FFFFFF;position: absolute;bottom: 0;width: 100%;font-size:12px;'>SINIRLI SAYIDA</div>";
    ...
    var _ed_SinirliSayidaBadgeCategory = new EightDigits.sf();
    _ed_SinirliSayidaBadgeCategory.SinirliSayidaBadgeCategory();
  })();
(function () {
    if (EightDigits.sf.prototype.hasOwnProperty("Samsung_Header_Banner")) {
        return false
    }
    EightDigits.sf.prototype.Samsung_Header_Banner = function () {
        var config = {
            scenarioname: "Samsung_Header_Banner",
            analytics: "Samsung_Header_Banner",
            controlgroup: 0
        };
        var main = {
            "factory": function () {
    ...
    var _ed_Samsung_Header_Banner = new EightDigits.sf();
    _ed_Samsung_Header_Banner.Samsung_Header_Banner();
  })();
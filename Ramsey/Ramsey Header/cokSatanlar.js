...
var scenarioClass = "smpl"
var scenarioId = "smplId"
var scenarioName = "smplName"
var variationId = "smplVar"
var sliderTitle = "Son Fırsatlar";
var ctMain = jQuery("a[href='" + location.pathname + "']").eq(0).attr('data-rel');
var locationOne = window.location.pathname.split("/")[1];
var locationTwo = window.location.pathname.split("/")[2];
var locationThree = window.location.pathname.split("/")[3]
var dataController = function () {
    ...
    var runAjax = function () {
        jQuery.ajax({
            type: "GET",
            url: "https://www.ramsey.com.tr/" + locationOne + "/" + locationTwo + "/" + locationThree + "/#o=6&g=2&ct=" + ctMain + "&u=48",
...
function startSmpl() {
    ...
    isDataHere = setInterval(() => {
        if (XMLData) {
            ...
            jQuery("#FilterForm").after(htmlObject);
            ...
            <div style="width:auto;white-space:nowrap; width:954px; margin: 19px auto;display:flex;justify-content:center;">';
                  ...
                  <div class="video-title">' +
                    ...
                    jQuery('#FilterForm').after(stories);

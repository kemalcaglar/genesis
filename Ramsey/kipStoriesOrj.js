                   ...
                   // setLevel(LEVEL_JOIN, 'Click_'+jQuery(this).find('.video-title').text());
                    ...
                    setTimeout(function () {
                      ...
                      ';
                        ...
                        jQuery('.smpl-progress .smpl-progress-bar:eq(0) .smpl-progress-bar-white').animate({ width: "100%" }, 1000 * timeInterval);
                       // EightDigits.analytics.sendEvent(config.analytics, "Click");
                         ...
                         function nextStory() {
                            timeOut = setTimeout(function () {
                                if (count < imgList.length - 1) {
                                    ...
                                    jQuery('.smpl-progress .smpl-progress-bar:eq(' + count + ') .smpl-progress-bar-white').animate({ width: "100%" }, 1000 * timeInterval);

(function () {
    if (EightDigits.sf.prototype.hasOwnProperty("Word_Listeleme_Banner_Mobile")) {
        return false
    }
    EightDigits.sf.prototype.Word_Listeleme_Banner_Mobile = function () {
        var config = {
            scenarioname: "Word_Listeleme_Banner_Mobile",
            analytics: "Word_Listeleme_Banner_Mobile",
            controlgroup: 0
        };
        var main = {
            "factory": function () {
                ...
                var hotelList = [
                  ...
                  jQuery(".booking-item").map(function () {
                    ...
                    if (hotelList.indexOf(hotelName) > -1) {
                      jQuery(this).append("<img class='smpl-word-banner' style='margin-top:-44px; height:34px; width:187px; left:10px; position:absolute;' src='https://cdn.8digits.com/log/r/7e9ae2d4-97e6-4ba4-8037-2f8039fd12af.png'>")
    ...
    var _ed_Word_Listeleme_Banner_Mobile = new EightDigits.sf();
    _ed_Word_Listeleme_Banner_Mobile.Word_Listeleme_Banner_Mobile();
  })();
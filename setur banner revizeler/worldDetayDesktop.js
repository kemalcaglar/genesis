(function () {
    if (EightDigits.sf.prototype.hasOwnProperty("Word_Detay_Banner_Desktop")) {
        return false
    }
    EightDigits.sf.prototype.Word_Detay_Banner_Desktop = function () {
        var config = {
            scenarioname: "Word_Detay_Banner_Desktop",
            analytics: "Word_Detay_Banner_Desktop",
            controlgroup: 0
        };
        var main = {
            "factory": function () {
    ...
    var hotelList = [
       ...
       hotelList.forEach(function (item) {
           if(jQuery(".hotel-detail-name").text().trim() === item){
             var html = `<div class="smpl-word-banner"><a href='https://www.setur.com.tr/setur-world-puan-kampanyasi' target='_blank'><img class="smpl-word" src="https://cdn.8digits.com/log/r/d0066047-6508-4f3b-a553-151ab7e65230.jpeg"></a></div>`;

             jQuery(".price-partial-shadow").eq(2).after(html);
    ...
    var _ed_Word_Detay_Banner_Desktop = new EightDigits.sf();
    _ed_Word_Detay_Banner_Desktop.Word_Detay_Banner_Desktop();
  })();
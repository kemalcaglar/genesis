          ...
          start: function () {
            ...
            arrProductHotel.forEach(function (item) {
              if(jQuery(".hotel-detail-name").text().trim() === item){
                ...
                <a href="https://www.setur.com.tr/taksitleri-4-ay-erteleme-kampanyasi" target="_blank"><img src="https://cdn.8digits.com/log/r/2d53739e-0d53-4028-8b08-1a5747654478.jpeg"></a></div>`;

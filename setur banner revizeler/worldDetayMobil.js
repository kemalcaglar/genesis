(function () {
    if (EightDigits.sf.prototype.hasOwnProperty("Word_Detay_Banner_Mobile")) {
        return false
    }
    EightDigits.sf.prototype.Word_Detay_Banner_Mobile = function () {
        var config = {
            scenarioname: "Word_Detay_Banner_Mobile",
            analytics: "Word_Detay_Banner_Mobile",
            controlgroup: 0
        };
        var main = {
            "factory": function () {
        ...
        "Kocca Ev",
         ...
         hotelList.forEach(function (item) {
            if(jQuery(".hotel-detail-name").text().trim() === item){
                var html = `<div class="smpl-word-banner" style="margin-bottom:10px;"><a href='https://www.setur.com.tr/setur-world-puan-kampanyasi' target='_blank'><img class="smpl-word" src="https://cdn.8digits.com/log/r/8895c7fc-c9c8-42f0-9a1c-21585e76d739.jpeg"></a></div>`;
    ...
    var _ed_Word_Detay_Banner_Mobile = new EightDigits.sf();
    _ed_Word_Detay_Banner_Mobile.Word_Detay_Banner_Mobile();
  })();
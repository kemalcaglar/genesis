            ...
            start: function () {
                var hotelList = [
                  ...
                  jQuery(".hotellist-item-information").map(function () {
                    ...
                    var hotelName = jQuery(this).find("h3").find("a").text().trim();
                    if (hotelList.indexOf(hotelName) > -1) {
                      jQuery(this).append("<img class='smpl-word-banner' style='margin-top:20px; height:34px; width:auto;' src='https://cdn.8digits.com/log/r/a311058d-55f4-46d6-b5b1-2c8601b9dfac.jpeg'>")

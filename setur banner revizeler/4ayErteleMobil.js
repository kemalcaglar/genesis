            ...
            start: function () {
              ...
              arrProductHotel.forEach(function (item) {
                if(jQuery(".hotel-detail-name").text().trim() === item){
                  var html = `<div class="smpl-taksit-banner">
                  <a style="width:100%" href="https://www.setur.com.tr/taksitleri-4-ay-erteleme-kampanyasi" target="_blank"><img src="https://cdn.8digits.com/log/r/cfc2cc7d-0757-4290-a76f-c9a82b614aa4.jpeg"></a></div>`;
                  jQuery('.content-partial-shadow.price-partial-shadow.display-only-mobile:eq(0)').after(html);
                  EightDigits.analytics.sendEvent(config.analytics, "shown_banner");
                }
              })
              jQuery(".smpl-taksit-banner").click(function(){

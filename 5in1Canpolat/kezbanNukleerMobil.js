(function () {
    if (EightDigits.sf.prototype.hasOwnProperty("Nukleer_Kulakcik_Mobile")) {
        return false
    }
    EightDigits.sf.prototype.Nukleer_Kulakcik_Mobile = function () {
        var config = {
            scenarioname: "Nukleer_Kulakcik_Mobile",
            analytics: "Nukleer_Kulakcik_Mobile",
            imgSrc:
            "https://cdn.8digits.com/log/r/f34f1588-c1e2-47fd-ab66-fe2355330c4d.jpeg",
            imgSrc2:"https://cdn.8digits.com/log/r/f34f1588-c1e2-47fd-ab66-fe2355330c4d.jpeg",
          altPropertie: "Bilgi ve Randevu İçin Tıklayın",
          mainLink:
            "https://www.anadolusaglik.org/doktor/doc-dr-kezban-berberoglu",
          direction:
            "https://www.anadolusaglik.org/nukleer-tip-bolumu",
    ...
    var _ed_Nukleer_Kulakcik_Mobile = new EightDigits.sf();
    _ed_Nukleer_Kulakcik_Mobile.Nukleer_Kulakcik_Mobile();
  })();
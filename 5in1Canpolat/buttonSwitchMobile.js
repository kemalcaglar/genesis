...
export default (scenarioId, variationId, options, preview) => {
    initialize({ type: TYPE_EMBEDED }, (config) => {
      ...
      toggleShow((status) => {
        if (!options.controlVariation) {
          if (status) {
            jQuery('.welcC , .headerUyeGiris').click(function(){
                              ...
                              if(!jQuery(getIframe).contents().find("#chkMailPermission").is(":checked")){
                                  ...
                                  jQuery(getIframe).contents().find("#userLoginBtnBackgroundPopUp").on('click',function(){
                                      ...
                                      if(!jQuery(getIframe).contents().find('#chkMailPermission').is(':checked')){
                                         ...
                                         <div style="position:absolute;z-index:99999;background-color:white;width:90%;height:275px;top:'+(window.innerHeight-275)/2+'px;left:'+(window.innerWidth-(window.innerWidth*0.9))/2+'px">\
                                         ...
                                         <a href="javascript:void(0)" style="border-radius:50%;background-color:white;position:absolute;z-index:999999;font-size:15px;bottom:-13px;left:'+((window.innerWidth*0.9)-24)/2+'px;cursor:pointer;width:24px;line-height:24px;height:24px;color:rgb(0,2,51);font-style:italic;font-weight:bolder;font-family:auto;" >i</a>\
                                         </div>\
                                          ...
                                          html+='\
                                              ...
                                              <div style="display:flex;flex-direction:row;justify-content:center;margin:40px auto 0px auto;width:100%;">\
                                              <div><a style="font-size:11px;background-color:rgb(158,192,229);color:white;padding:10px 7px;" href="javascript:void(0)" class="smpl-mail-onay-hata">E-POSTA ONAYI VERMEDEN İLERLE</a></div>\
                                              <div style="margin-right:10px;"><a style="font-size:11px;\
                                                  background-color: rgb(0,2,51);\
                                                  padding: 10px 7px;\
                                                  text-transform: uppercase;\
                                                  color: white;\
                                                  box-shadow: 0px 5px 12px #9ec0e5;\
                                                  transition: all 0.3s ease 0s;\
                                                  cursor: pointer;\
                                                  margin-left: 9px;\
                                                  border: 1px solid white;" href="javascript:void(0)" class="smpl-mail-onay">E-POSTA ONAYI VER</a></div>\
                                              </div>\
                                          </div>\
                                         </div>\
                                      </div>';
                                          ...
                                          if(window.innerWidth<360){
                                              jQuery('.smpl-mail-onay-hata').css("font-size","9.5px")
                                              jQuery('.smpl-mail-onay').css("font-size","9.5px")
                                          }
  ...
  jQuery('.headerUyeOl').on('click',function(){
                          ...
                          if(!jQuery(getIframe).contents().find('#chkMailPermission').is(':checked')){
                             ...
                             <a href="javascript:void(0)" style="border-radius:50%;background-color:white;position:absolute;z-index:999999;font-size:15px;bottom:-13px;left:'+((window.innerWidth*0.9)-24)/2+'px;cursor:pointer;width:24px;line-height:24px;height:24px;color:rgb(0,2,51);font-style:italic;font-weight:bolder;font-family:auto;" >i</a>\
                              ...
                              html+='\
                                  <div style="width:80%;margin:0 auto;font-size:14px;"><span>İletişim onayı vermediğin için sana özel <span style="font-weight:bold;">indirim ve kampanyalarımızdan</span> haberdar olamayacaksın.</span></div>\
                                  <div style="display:flex;flex-direction:row;justify-content:center;margin:40px auto 0px auto;width:100%;">\
                                      <div style="margin-right:10px;"><a style="font-size:11px;background-color:rgb(158,192,229);color:white;padding:10px 7px;" href="javascript:void(0)" class="smpl-mail-onay">E-POSTA ONAYI VER</a></div>\
                                      <div><a style="background-color:rgb(0,2,51);font-size:11px;color:white;padding:10px 7px;" href="javascript:void(0)" class="smpl-mail-onay-hata">E-POSTA ONAYI VERMEDEN İLERLE</a></div>\
                                  </div>\
                              </div>\
                             </div>\
                          </div>';

                                       ...
                                       <a href="javascript:void(0)" style="border-radius:50%;background-color:white;position:absolute;z-index:999999;font-size:15px;bottom:-13px;left:'+((window.innerWidth*0.9)-24)/2+'px;cursor:pointer;width:24px;line-height:24px;height:24px;color:rgb(0,2,51);font-style:italic;font-weight:bolder;font-family:auto;" >i</a>\
                                        ...
                                        html+='\
                                            ...
                                            <div style="display:flex;flex-direction:row;justify-content:center;margin:40px auto 0px auto;width:100%;">\
                                                ...
                                                <div><a style="font-size:11px;background-color:rgb(0,2,51);color:white;padding:10px 7px;" href="javascript:void(0)" class="smpl-mail-onay-hata">E-POSTA ONAYI VERMEDEN İLERLE</a></div>\
                                            </div>\
                                        </div>\
                                       </div>\
                                    </div>';

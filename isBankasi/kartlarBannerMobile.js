(function () {
  if (EightDigits.sf.prototype.hasOwnProperty("Kartlar_Banner_Mobile")) {
      return false
  }
  EightDigits.sf.prototype.Kartlar_Banner_Mobile = function () {
      var config = {
          scenarioname: "Kartlar_Banner_Mobile",
          analytics: "Kartlar_Banner_Mobile",
          controlgroup: 0
      };
      var main = {
          "factory": function () {
      ...
      main.factory.prototype = {
          ...
          start: function () {
            ...
            <div class="smpl_Hdr" style="float: none;clear: both;color: #4c4b4b;font-size: 22px !important;font-family: sans-serif;font-weight: bold;margin-left: 8px;">Dijital Kasa</div>\
            ...
            <div class="smpl_FontSize smpl_PushRight smpl_Center">\
            <div class="smpl_Btc">\
            ...
            if (window.location.pathname == "/TR/kampanyalar/Sayfalar/kampanyalar.aspx"){
              ...
              jQuery(".smpl_storeimgLink1").click(function(){
                EightDigits.analytics.sendEvent(config.analytics, 'click_playstore_mobile');
              })
              jQuery(".smpl_ClickLink2").click(function(){
                EightDigits.analytics.sendEvent(config.analytics, 'click_appstore_mobile');
              })
              jQuery(".smpl_storeimgLink3").click(function(){
                EightDigits.analytics.sendEvent(config.analytics, 'click_huaweistore_mobile');
              })
              EightDigits.analytics.sendEvent(config.analytics, 'shown_mobile');
            }else if (window.location.pathname == "/TR/ticari-kartlar/Sayfalar/ticari.aspx"){
  ...
  var _ed_Kartlar_Banner_Mobile = new EightDigits.sf();
  _ed_Kartlar_Banner_Mobile.Kartlar_Banner_Mobile();
})();
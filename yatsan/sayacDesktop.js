var dateChecker = function () {
    var now = new Date();
    var startDate = new Date("Sep 22, 2021 11:09:00").getTime();
...
<span style="display: flex;position: relative;right: 11px;font-size: 17px;font-weight: 600;top: 8px;">Sepette Ek İndirimler için Son Saatler</span>\
...
';
    ...
    var countDownDate2 = new Date("Sep 23, 2021 23:59:59").getTime();

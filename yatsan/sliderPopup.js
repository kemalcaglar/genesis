...
<div class="smpl-contentPopup">
  ...
  padding-top: 10px;
  padding-bottom: 10px;
  margin-bottom: 10px;">Aradığını bulamadın mı? Senin için seçtiklerimize gözat! <span class="smpl-popupClose" style="right: 10px;position: absolute;top: 5px;font-size: 30px; cursor:pointer;">&times</span></h1>  <div class="swiper-container swiper-container-horizontal" id="swiper-container2" style="width:800px;">
  <div class="swiper-wrapper" style="transform: translate3d(0px, 0px, 0px); transition-duration: 0ms;">
      <div class="swiper-slide active-slider swiper-slide-visible swiper-slide-active" style="width: 400px;">
          <a class="smpl-productHref" href="`+dataProduct[0].productOneHref+`"><div style="justify-content: center;display: flex;text-align: center;align-items: center;margin-top: -20px;
          line-height: 25px;">
          ...
          <div class="button smpl-button" style="text-align: center;margin-top: 10px;margin-bottom: 40px;"">
      ...
      <div class="swiper-slide swiper-slide-visible swiper-slide-next" style="width: 400px;">
      <a class="smpl-productHref" href="`+dataProduct[1].productTwoHref+`"><div style="justify-content: center;display: flex;text-align: center;align-items: center;margin-top: -20px;
      line-height: 25px;">
      ...
      <a class="smpl-productHref" href="`+dataProduct[2].productThreeHref+`"><div style="justify-content: center;display: flex;text-align: center;align-items: center;margin-top: -20px;
      line-height: 25px;">

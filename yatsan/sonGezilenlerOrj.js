      ...
      .content::-webkit-scrollbar-thumb {
        background-color: rgb(103, 61, 39);
          outline: 1px solid rgb(103, 61, 39);
                                ...
                                var imgSrc =
                                    "https://cdn.hellosmpl.com/uploads/2021/06/02/l2m1vgonfs19psc7h2ou957c94.png";
                                var kulakcikHTML =
                                    ...
                                    imgSrc +
                                    ");background-size:cover;background-repeat:no-repeat; text-align: center; color: white; display: none; flex-direction: column; justify-content: center; border-top-left-radius: 3px; border-bottom-left-radius: 3px;transform: rotate(-90deg);'><span style='margin-top:24px;margin-bottom:10px;font-size:17px;color:white;text-orientation: upright;'></span></div>";
...
jQuery("head").append(css);
        jQuery(window).scroll(function () {
            if (jQuery(window).scrollTop() > 200) {
                jQuery('#lastLookTrigger').addClass("smpl-lastLook");
                    //setLevel(LEVEL_JOIN, "click-category");
            } else {
                jQuery('#lastLookTrigger').removeClass("smpl-lastLook");
            }
        });
                                ...
                                jQuery("#lastLookTrigger").click(function () {
                                    ...
                                    setLevel(LEVEL_JOIN, "click-modal");
                                });
                            }
                        }
                    }

setTimeout(function () {
    ...
    jQuery(".product-area .product-list .pitem").each(function (i, product) {
      if (i == count) {
        ...
        newHtml = '<div class="pitem parent-pitem col-md-4 smplProductCardOnlineOzel">' + newHtml + '</div>'
        jQuery(this).before(newHtml)
      }
    })
    var element = jQuery(".smplProductCardOnlineOzel");
    var display = {
      display: "none",
    };
    var imgSrc =
      "https://cdn.hellosmpl.com/uploads/2021/07/27/4u2iahk34m7prvmsqgunuvhtc.png"; /* image */
    var linkDirection = "https://yatsan.com/d/online-ozel-urunler"; /* link yönlendirmesi */
    var linkMessage = "Online Özel" /* img alt propertiesinde yazacak mesaj */

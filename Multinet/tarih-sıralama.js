          ...
          function pazarRun() {
            if (gunler[tarih.getDay()] === "Cuma") {
              if (!cookie.getCookie("popupCookie")) {
                if (localStorage.getItem("notificationData") == null) {
                  ...
                  localStorage.setItem("notificationData", JSON.stringify(dataDay))
                }
                cookie.setCookie("popupCookie", 1, 2);
              }
            }
          };
          pazarRun();
          var count = 4;
          var dataFromLocal = localStorage.getItem("notificationData")
          var html = '\
 ...
 */
          ...
          setTimeout(function () {
            ...
            var dc = dataFromLocal.length;

            jQuery.each(dataFromLocal, function (i, line) {
